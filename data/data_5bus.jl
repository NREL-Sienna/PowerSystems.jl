...
branches5 = [Line("1", true, @NT(from=nodes5[1],to=nodes5[2]), 0.00281, 0.0281, 0.00712, 400.0, nothing),
             Line("2", true, @NT(from=nodes5[1],to=nodes5[4]), 0.00304, 0.0304, 0.00658, 3960.0, nothing),
             Line("3", true, @NT(from=nodes5[1],to=nodes5[5]), 0.00064, 0.0064, 0.03126, 18812.0, nothing),
             Line("4", true, @NT(from=nodes5[2],to=nodes5[3]), 0.00108, 0.0108, 0.01852, 11148.0, nothing),
             Line("5", true, @NT(from=nodes5[3],to=nodes5[4]), 0.00297, 0.0297, 0.00674, 4053.0, nothing),
             Line("6", true, @NT(from=nodes5[4],to=nodes5[5]), 0.00297, 0.0297, 0.00674, 240.0, nothing)
];
