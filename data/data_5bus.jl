...
branches5 = [Line("1", true, @NT(from=nodes5[1],to=nodes5[2]), 0.00281, 0.0281, 0.00712, 400.0, @NT(max = 60.0, min = -60.0)),
             Line("2", true, @NT(from=nodes5[1],to=nodes5[4]), 0.00304, 0.0304, 0.00658, 3960.0, @NT(max = 60.0, min = -60.0)),
             Line("3", true, @NT(from=nodes5[1],to=nodes5[5]), 0.00064, 0.0064, 0.03126, 18812.0, @NT(max = 60.0, min = -60.0)),
             Line("4", true, @NT(from=nodes5[2],to=nodes5[3]), 0.00108, 0.0108, 0.01852, 11148.0, @NT(max = 60.0, min = -60.0)),
             Line("5", true, @NT(from=nodes5[3],to=nodes5[4]), 0.00297, 0.0297, 0.00674, 4053.0, @NT(max = 60.0, min = -60.0)),
             Line("6", true, @NT(from=nodes5[4],to=nodes5[5]), 0.00297, 0.0297, 0.00674, 240.0, @NT(max = 60.0, min = -60.0))
];
