...
function download_data(tag::String)
    ...
    if !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/HYDRO/DAY_AHEAD_hydro.csv")) & !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/HYDRO/REAL_TIME_hydro.csv"))
    ...
    if !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/Load/DAY_AHEAD_regional_Load.csv")) & !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/Load/REAL_TIME_regional_load.csv"))
    ...
    if !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/PV/DAY_AHEAD_pv.csv")) & !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/PV/REAL_TIME_pv.csv"))
    ...
    if !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/RTPV/DAY_AHEAD_rtpv.csv")) & !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/RTPV/REAL_TIME_rtpv.csv"))
    ...
    if !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/WIND/DAY_AHEAD_wind.csv")) & !isdir(Pkg.dir("PowerSystems/data/forecasts/RTS_GMLC_forecasts/WIND/REAL_TIME_wind.csv"))
