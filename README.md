...
[![Build Status](https://travis-ci.com/NREL/PowerSystems.jl.svg?branch=master)](https://travis-ci.org/NREL/PowerSystems.jl)
...
- The latest tagged version in PowerSystems (v0.6.0) will work with Julia v1.2+.
