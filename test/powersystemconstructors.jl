...
@testset "Test System constructors" begin
    ...
    sys5 = System(nodes5, generators5, loads5_DA, nothing, nothing,  100.0, nothing, nothing, nothing)
    sys5 = System(nodes5, generators5, loads5_DA, branches5, nothing,  100.0, nothing, nothing, nothing)
    ...
    sys5b = System(nodes5, generators5, loads5_DA, nothing, battery5,  100.0, nothing, nothing, nothing)

    sys5b = System(nodes5, generators5, loads5_DA, nothing, battery5,  100.0, forecasts5, nothing, nothing)
    ...
    sys14 = System(nodes14, generators14, loads14, nothing, nothing, 100.0, Dict{Symbol,Vector{<:Forecast}}(),nothing,nothing)
    sys14 = System(nodes14, generators14, loads14, branches14, nothing, 100.0, forecasts14, nothing, nothing)
    ...
    sys14b = System(nodes14, generators14, loads14, nothing, battery14, 100.0, nothing, nothing, nothing)
    sys14b = System(nodes14, generators14, loads14, branches14, battery14, 100.0, nothing, nothing, nothing)
