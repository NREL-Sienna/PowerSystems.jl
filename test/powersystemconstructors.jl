...
@testset "Test System constructors from .jl files" begin
    ...
    c_sys5 = PowerSystems.System(sys5)
    ...
    c_sys5b = PowerSystems.System(sys5b)
    ...
    c_sys5bh = PowerSystems.System(sys5bh)
    ...
    c_sys14 = PowerSystems.System(sys14)
    ...
    c_sys14b = PowerSystems.System(sys14b)
...
@testset "Test System constructor from Matpower" begin
    ...
    c_sys1 = PowerSystems.System(sys)
end
