...
thermal_generators14(nodes14) = [ThermalStandard("Bus1", true, nodes14[1], 2.0, -0.169,
...
loads14(nodes14) = [PowerLoad("Bus2", true, nodes14[2], PowerSystems.ConstantPower, 0.217, 0.127, 0.217, 0.127),
...
battery14(nodes14) = [GenericBattery(name = "Bat",
