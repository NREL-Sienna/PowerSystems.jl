...
@testset "2-area, 11-bus, 4-generator benchmark system Parsing " begin
    ...
    sys = parse_dyn_system(ger4_raw_file, ger4_dyr_file)
...
@testset "GENCLS dyr parsing" begin
    ...
    sys_gencls = parse_dyn_system(threebus_raw_file, gencls_dyr_file)
    sys_nogencls = parse_dyn_system(threebus_raw_file, nogencls_dyr_file)
