...
forecast_gen = PowerSystems.make_forecast_dict(rt_time_series,Dates.Day(1),24,Generators);
forecast_load = PowerSystems.make_forecast_dict(rt_time_series,Dates.Day(1),24,Loads, LoadZones);
