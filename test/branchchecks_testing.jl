...
@testset "Angle limits" begin
    ...
    branches_test = [
        Line("1", true, 0.0, 0.0, Arch(from=nodes5[1], to=nodes5[2]), 0.00281, 0.0281,
        ...
        Line("4", true, 0.0, 0.0, Arch(from=nodes5[2], to=nodes5[3]), 0.00108, 0.0108,
             (from=0.00926, to=0.00926), 11148.0, (min=0.0, max=0.0)),
        Line("5", true, 0.0, 0.0, Arch(from=nodes5[3], to=nodes5[4]), 0.00297, 0.0297,
             (from=0.00337, to=0.00337), 4053.0, (min=-1.2, max=60.0)),
        Line("6", true, 0.0, 0.0, Arch(from=nodes5[4], to=nodes5[5]), 0.00297, 0.0297,
