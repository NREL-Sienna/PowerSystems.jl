...
lines_full = [Line(1, true, (nodes_ac[1],nodes_ac[2]), 230.0, 0.00281, 0.0281, 0.00712, 400.0),
...
Net1 = Network(FiveBus, lines_full, nodes_ac) 

lines_incomplete = [Line(1, true, (nodes_nn[1],nodes_nn[2]), 230.0, 0.00281, 0.0281, 0.00712, 400.0),
...
Net2 = Network(FiveBus, lines_incomplete, nodes_ac) 
