...
@testset "PSSE Component Parsing" begin
    ...
    @test get_active_power(get_component(PowerLoad, sys, "bus14")) == 1.94
    @test get_max_reactive_power(get_component(PowerLoad, sys, "bus14")) == 0.39
    @test get_conformity(get_component(PowerLoad, sys, "bus14")) == LoadConformity.CONFORMING
    ...
    @test get_conformity(get_component(StandardLoad, sys, "load71")) == LoadConformity.CONFORMING
