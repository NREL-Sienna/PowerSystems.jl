    ...
    if haskey(pti_data, "TRANSFORMER")
        for transformer in pti_data["TRANSFORMER"]
            if transformer["K"] == 0  # Two-winding Transformers
                ...
                bus_id1, bus_id2, bus_id3 = transformer["I"],
                    transformer["J"],
                    transformer["K"]
                ...
                br_r12, br_r23, br_r31 = transformer["R1-2"],
                    transformer["R2-3"],
                    transformer["R3-1"]
                br_x12, br_x23, br_x31 = transformer["X1-2"],
                    transformer["X2-3"],
                    transformer["X3-1"]
