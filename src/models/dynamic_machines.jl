...
set_base_machine!(value::SalientPoleExponential, val::SalientPoleMachine) = value.base_machine
...
set_saturation_coeffs!(value::SalientPoleQuadratic, val::Tuple{Float64, Float64}) = value.saturation_coeffs
set_saturation_coeffs!(value::SalientPoleExponential, val::Tuple{Float64, Float64}) = value.saturation_coeffs
set_saturation_coeffs!(value::RoundRotorQuadratic, val::Tuple{Float64, Float64}) = value.saturation_coeffs
set_saturation_coeffs!(value::RoundRotorExponential, val::Tuple{Float64, Float64}) = value.saturation_coeffs
