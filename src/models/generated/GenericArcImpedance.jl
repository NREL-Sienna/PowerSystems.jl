...
function GenericArcImpedance(; name, available, active_power_flow, reactive_power_flow, max_flow, arc, r, x, base_power=100.0, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, max_flow = max_flow, arc = arc, r = r, x = x, base_power = base_power, ext = ext, )
    GenericArcImpedance(name, available, construct_value(GenericArcImpedance, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(GenericArcImpedance, _construction_fields, Val(:reactive_power_flow), Val(:mva)), construct_value(GenericArcImpedance, _construction_fields, Val(:max_flow), Val(:mva)), arc, construct_value(GenericArcImpedance, _construction_fields, Val(:r), Val(:ohm)), construct_value(GenericArcImpedance, _construction_fields, Val(:x), Val(:ohm)), base_power, ext, internal, )
end
