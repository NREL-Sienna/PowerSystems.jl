...
set_R!(value::SimpleFullMachine, val::Float64) = value.R = val
"""Set SimpleFullMachine R_f."""
set_R_f!(value::SimpleFullMachine, val::Float64) = value.R_f = val
"""Set SimpleFullMachine R_1d."""
set_R_1d!(value::SimpleFullMachine, val::Float64) = value.R_1d = val
"""Set SimpleFullMachine R_1q."""
set_R_1q!(value::SimpleFullMachine, val::Float64) = value.R_1q = val
"""Set SimpleFullMachine L_d."""
set_L_d!(value::SimpleFullMachine, val::Float64) = value.L_d = val
"""Set SimpleFullMachine L_q."""
set_L_q!(value::SimpleFullMachine, val::Float64) = value.L_q = val
"""Set SimpleFullMachine L_ad."""
set_L_ad!(value::SimpleFullMachine, val::Float64) = value.L_ad = val
"""Set SimpleFullMachine L_aq."""
set_L_aq!(value::SimpleFullMachine, val::Float64) = value.L_aq = val
"""Set SimpleFullMachine L_f1d."""
set_L_f1d!(value::SimpleFullMachine, val::Float64) = value.L_f1d = val
"""Set SimpleFullMachine L_ff."""
set_L_ff!(value::SimpleFullMachine, val::Float64) = value.L_ff = val
...
set_inv_d_fluxlink!(value::SimpleFullMachine, val::Array{Float64,2}) = value.inv_d_fluxlink = val
"""Set SimpleFullMachine inv_q_fluxlink."""
set_inv_q_fluxlink!(value::SimpleFullMachine, val::Array{Float64,2}) = value.inv_q_fluxlink = val
"""Set SimpleFullMachine states."""
set_states!(value::SimpleFullMachine, val::Vector{Symbol}) = value.states = val
"""Set SimpleFullMachine n_states."""
set_n_states!(value::SimpleFullMachine, val::Int64) = value.n_states = val
"""Set SimpleFullMachine internal."""
set_internal!(value::SimpleFullMachine, val::InfrastructureSystemsInternal) = value.internal = val
