...
- `control_objective_primary::TransformerControlObjective`: (default: `TransformerControlObjective.UNDEFINED`) Control objective for the tap changer for winding 1. See [`TransformerControlObjective`](@ref TransformerControlObjective)
- `control_objective_secondary::TransformerControlObjective`: (default: `TransformerControlObjective.UNDEFINED`) Control objective for the tap changer for winding 2. See [`TransformerControlObjective`](@ref TransformerControlObjective)
- `control_objective_tertiary::TransformerControlObjective`: (default: `TransformerControlObjective.UNDEFINED`) Control objective for the tap changer for winding 3. See [`TransformerControlObjective`](@ref TransformerControlObjective)
...
mutable struct Transformer3W <: ThreeWindingTransformer
    ...
    "Vector group number ('clock number') indicating fixed phase shift (radians) between the `from` and `to` buses due to the connection group configuration"
    tertiary_group_number::WindingGroupNumber
    "Control objective for the tap changer for winding 1. See [`TransformerControlObjective`](@ref TransformerControlObjective)"
    control_objective_primary::TransformerControlObjective
    "Control objective for the tap changer for winding 2. See [`TransformerControlObjective`](@ref TransformerControlObjective)"
    control_objective_secondary::TransformerControlObjective
    "Control objective for the tap changer for winding 3. See [`TransformerControlObjective`](@ref TransformerControlObjective)"
    control_objective_tertiary::TransformerControlObjective
