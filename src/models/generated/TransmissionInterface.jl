...
- `direction_mapping::Dict{String, Int}`: (optional) Dictionary of the line `name`s in the interface and their direction of flow (1 or -1) relative to the flow of the interface
...
mutable struct TransmissionInterface <: Service
    ...
    violation_penalty::Float64
    "(optional) Dictionary of the line `name`s in the interface and their direction of flow (1 or -1) relative to the flow of the interface"
    direction_mapping::Dict{String, Int}
