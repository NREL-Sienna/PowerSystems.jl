...
get_active_power_flow_limits(value::TransmissionInterface) = get_value(value, value.active_power_flow_limits, Val(:mva))
...
set_active_power_flow_limits!(value::TransmissionInterface, val) = value.active_power_flow_limits = set_value(value, val, Val(:mva))
