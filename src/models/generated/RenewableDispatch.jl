...
get_active_power(value::RenewableDispatch) = get_value(value, value.active_power, Val(:mva))
"""Get [`RenewableDispatch`](@ref) `reactive_power`."""
get_reactive_power(value::RenewableDispatch) = get_value(value, value.reactive_power, Val(:mva))
"""Get [`RenewableDispatch`](@ref) `rating`."""
get_rating(value::RenewableDispatch) = get_value(value, value.rating, Val(:mva))
...
get_reactive_power_limits(value::RenewableDispatch) = get_value(value, value.reactive_power_limits, Val(:mva))
...
set_active_power!(value::RenewableDispatch, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`RenewableDispatch`](@ref) `reactive_power`."""
set_reactive_power!(value::RenewableDispatch, val) = value.reactive_power = set_value(value, val, Val(:mva))
"""Set [`RenewableDispatch`](@ref) `rating`."""
set_rating!(value::RenewableDispatch, val) = value.rating = set_value(value, val, Val(:mva))
...
set_reactive_power_limits!(value::RenewableDispatch, val) = value.reactive_power_limits = set_value(value, val, Val(:mva))
