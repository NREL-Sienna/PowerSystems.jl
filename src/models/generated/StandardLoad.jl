...
function StandardLoad(name, available, bus, base_power, constant_active_power=0.0, constant_reactive_power=0.0, impedance_active_power=0.0, impedance_reactive_power=0.0, current_active_power=0.0, current_reactive_power=0.0, max_constant_active_power=0.0, max_constant_reactive_power=0.0, max_impedance_active_power=0.0, max_impedance_reactive_power=0.0, max_current_active_power=0.0, max_current_reactive_power=0.0, conformity=LoadConformity.UNDEFINED, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, bus = bus, base_power = base_power, constant_active_power = constant_active_power, constant_reactive_power = constant_reactive_power, impedance_active_power = impedance_active_power, impedance_reactive_power = impedance_reactive_power, current_active_power = current_active_power, current_reactive_power = current_reactive_power, max_constant_active_power = max_constant_active_power, max_constant_reactive_power = max_constant_reactive_power, max_impedance_active_power = max_impedance_active_power, max_impedance_reactive_power = max_impedance_reactive_power, max_current_active_power = max_current_active_power, max_current_reactive_power = max_current_reactive_power, conformity = conformity, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    StandardLoad(name, available, bus, base_power, construct_value(StandardLoad, _construction_fields, Val(:constant_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:constant_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:impedance_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:impedance_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:current_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:current_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_constant_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_constant_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_impedance_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_impedance_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_current_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_current_reactive_power), Val(:mva)), conformity, services, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end

function StandardLoad(; name, available, bus, base_power, constant_active_power=0.0, constant_reactive_power=0.0, impedance_active_power=0.0, impedance_reactive_power=0.0, current_active_power=0.0, current_reactive_power=0.0, max_constant_active_power=0.0, max_constant_reactive_power=0.0, max_impedance_active_power=0.0, max_impedance_reactive_power=0.0, max_current_active_power=0.0, max_current_reactive_power=0.0, conformity=LoadConformity.UNDEFINED, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, bus = bus, base_power = base_power, constant_active_power = constant_active_power, constant_reactive_power = constant_reactive_power, impedance_active_power = impedance_active_power, impedance_reactive_power = impedance_reactive_power, current_active_power = current_active_power, current_reactive_power = current_reactive_power, max_constant_active_power = max_constant_active_power, max_constant_reactive_power = max_constant_reactive_power, max_impedance_active_power = max_impedance_active_power, max_impedance_reactive_power = max_impedance_reactive_power, max_current_active_power = max_current_active_power, max_current_reactive_power = max_current_reactive_power, conformity = conformity, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    StandardLoad(name, available, bus, base_power, construct_value(StandardLoad, _construction_fields, Val(:constant_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:constant_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:impedance_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:impedance_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:current_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:current_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_constant_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_constant_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_impedance_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_impedance_reactive_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_current_active_power), Val(:mva)), construct_value(StandardLoad, _construction_fields, Val(:max_current_reactive_power), Val(:mva)), conformity, services, dynamic_injector, ext, internal, )
end
