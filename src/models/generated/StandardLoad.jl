...
- `constant_active_power::Float64`: (optional) Constant active power demand in MW (P_P)
- `constant_reactive_power::Float64`: (optional) Constant reactive power demand in MVAR (Q_P)
- `impedance_active_power::Float64`: (optional) Active power coefficient in MW for constant impedance load (P_Z)
- `impedance_reactive_power::Float64`: (optional) Reactive power coefficient in MVAR for constant impedance load (Q_Z)
- `current_active_power::Float64`: (optional) Active power coefficient in MW for constant current load (P_I)
- `current_reactive_power::Float64`: (optional) Reactive power coefficient in MVAR for constant current load (Q_I)
- `max_constant_active_power::Float64`: (optional) Maximum active power (MW) drawn by constant power load
- `max_constant_reactive_power::Float64`: (optional) Maximum reactive power (MVAR) drawn by constant power load
- `max_impedance_active_power::Float64`: (optional) Maximum active power (MW) drawn by constant impedance load
- `max_impedance_reactive_power::Float64`: (optional) Maximum reactive power (MVAR) drawn by constant impedance load
- `max_current_active_power::Float64`: (optional) Maximum active power (MW) drawn by constant current load
- `max_current_reactive_power::Float64`: (optional) Maximum reactive power (MVAR) drawn by constant current load
...
mutable struct StandardLoad <: StaticLoad
    ...
    base_power::Float64
    "(optional) Constant active power demand in MW (P_P)"
    constant_active_power::Float64
    "(optional) Constant reactive power demand in MVAR (Q_P)"
    constant_reactive_power::Float64
    "(optional) Active power coefficient in MW for constant impedance load (P_Z)"
    impedance_active_power::Float64
    "(optional) Reactive power coefficient in MVAR for constant impedance load (Q_Z)"
    impedance_reactive_power::Float64
    "(optional) Active power coefficient in MW for constant current load (P_I)"
    current_active_power::Float64
    "(optional) Reactive power coefficient in MVAR for constant current load (Q_I)"
    current_reactive_power::Float64
    "(optional) Maximum active power (MW) drawn by constant power load"
    max_constant_active_power::Float64
    "(optional) Maximum reactive power (MVAR) drawn by constant power load"
    max_constant_reactive_power::Float64
    "(optional) Maximum active power (MW) drawn by constant impedance load"
    max_impedance_active_power::Float64
    "(optional) Maximum reactive power (MVAR) drawn by constant impedance load"
    max_impedance_reactive_power::Float64
    "(optional) Maximum active power (MW) drawn by constant current load"
    max_current_active_power::Float64
    "(optional) Maximum reactive power (MVAR) drawn by constant current load"
    max_current_reactive_power::Float64
