...
get_storage_capacity(value::EnergyReservoirStorage) = get_value(value, value.storage_capacity, Val(:mva))
...
get_rating(value::EnergyReservoirStorage) = get_value(value, value.rating, Val(:mva))
"""Get [`EnergyReservoirStorage`](@ref) `active_power`."""
get_active_power(value::EnergyReservoirStorage) = get_value(value, value.active_power, Val(:mva))
"""Get [`EnergyReservoirStorage`](@ref) `input_active_power_limits`."""
get_input_active_power_limits(value::EnergyReservoirStorage) = get_value(value, value.input_active_power_limits, Val(:mva))
"""Get [`EnergyReservoirStorage`](@ref) `output_active_power_limits`."""
get_output_active_power_limits(value::EnergyReservoirStorage) = get_value(value, value.output_active_power_limits, Val(:mva))
...
get_reactive_power(value::EnergyReservoirStorage) = get_value(value, value.reactive_power, Val(:mva))
"""Get [`EnergyReservoirStorage`](@ref) `reactive_power_limits`."""
get_reactive_power_limits(value::EnergyReservoirStorage) = get_value(value, value.reactive_power_limits, Val(:mva))
...
set_storage_capacity!(value::EnergyReservoirStorage, val) = value.storage_capacity = set_value(value, val, Val(:mva))
...
set_rating!(value::EnergyReservoirStorage, val) = value.rating = set_value(value, val, Val(:mva))
"""Set [`EnergyReservoirStorage`](@ref) `active_power`."""
set_active_power!(value::EnergyReservoirStorage, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`EnergyReservoirStorage`](@ref) `input_active_power_limits`."""
set_input_active_power_limits!(value::EnergyReservoirStorage, val) = value.input_active_power_limits = set_value(value, val, Val(:mva))
"""Set [`EnergyReservoirStorage`](@ref) `output_active_power_limits`."""
set_output_active_power_limits!(value::EnergyReservoirStorage, val) = value.output_active_power_limits = set_value(value, val, Val(:mva))
...
set_reactive_power!(value::EnergyReservoirStorage, val) = value.reactive_power = set_value(value, val, Val(:mva))
"""Set [`EnergyReservoirStorage`](@ref) `reactive_power_limits`."""
set_reactive_power_limits!(value::EnergyReservoirStorage, val) = value.reactive_power_limits = set_value(value, val, Val(:mva))
