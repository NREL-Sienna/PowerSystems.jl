...
get_requirement(value::ConstantReserveNonSpinning) = get_value(value, value.requirement, Val(:mva))
...
set_requirement!(value::ConstantReserveNonSpinning, val) = value.requirement = set_value(value, val, Val(:mva))
