...
"""Set ESDC2A Tr."""
set_Tr!(value::ESDC2A, val::Float64) = value.Tr = val
"""Set ESDC2A Ka."""
set_Ka!(value::ESDC2A, val::Float64) = value.Ka = val
"""Set ESDC2A Ta."""
set_Ta!(value::ESDC2A, val::Float64) = value.Ta = val
"""Set ESDC2A Tb."""
set_Tb!(value::ESDC2A, val::Float64) = value.Tb = val
"""Set ESDC2A Tc."""
set_Tc!(value::ESDC2A, val::Float64) = value.Tc = val
"""Set ESDC2A Vr_lim."""
set_Vr_lim!(value::ESDC2A, val::Tuple{Float64, Float64}) = value.Vr_lim = val
"""Set ESDC2A Ke."""
set_Ke!(value::ESDC2A, val::Float64) = value.Ke = val
"""Set ESDC2A Te."""
set_Te!(value::ESDC2A, val::Float64) = value.Te = val
"""Set ESDC2A Kf."""
set_Kf!(value::ESDC2A, val::Float64) = value.Kf = val
"""Set ESDC2A Tf."""
set_Tf!(value::ESDC2A, val::Float64) = value.Tf = val
"""Set ESDC2A switch."""
set_switch!(value::ESDC2A, val::Int) = value.switch = val
"""Set ESDC2A E_sat."""
set_E_sat!(value::ESDC2A, val::Tuple{Float64, Float64}) = value.E_sat = val
"""Set ESDC2A Se."""
set_Se!(value::ESDC2A, val::Tuple{Float64, Float64}) = value.Se = val
"""Set ESDC2A V_ref."""
set_V_ref!(value::ESDC2A, val::Float64) = value.V_ref = val
"""Set ESDC2A saturation_coeffs."""
set_saturation_coeffs!(value::ESDC2A, val::Tuple{Float64, Float64}) = value.saturation_coeffs = val
"""Set ESDC2A ext."""
set_ext!(value::ESDC2A, val::Dict{String, Any}) = value.ext = val
"""Set ESDC2A states."""
set_states!(value::ESDC2A, val::Vector{Symbol}) = value.states = val
"""Set ESDC2A n_states."""
set_n_states!(value::ESDC2A, val::Int) = value.n_states = val
"""Set ESDC2A states_types."""
set_states_types!(value::ESDC2A, val::Vector{StateTypes.StateType}) = value.states_types = val
"""Set ESDC2A internal."""
set_internal!(value::ESDC2A, val::InfrastructureSystemsInternal) = value.internal = val
