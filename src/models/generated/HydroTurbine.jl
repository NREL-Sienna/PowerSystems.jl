...
function HydroTurbine(name, available, bus, active_power, reactive_power, rating, active_power_limits, reactive_power_limits, base_power, operation_cost=HydroGenerationCost(nothing), powerhouse_elevation=0.0, ramp_limits=nothing, time_limits=nothing, outflow_limits=nothing, efficiency=1.0, turbine_type=HydroTurbineType.UNKNOWN, conversion_factor=1.0, prime_mover_type=PrimeMovers.HY, travel_time=nothing, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, base_power = base_power, operation_cost = operation_cost, powerhouse_elevation = powerhouse_elevation, ramp_limits = ramp_limits, time_limits = time_limits, outflow_limits = outflow_limits, efficiency = efficiency, turbine_type = turbine_type, conversion_factor = conversion_factor, prime_mover_type = prime_mover_type, travel_time = travel_time, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    HydroTurbine(name, available, bus, construct_value(HydroTurbine, _construction_fields, Val(:active_power), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:rating), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:reactive_power_limits), Val(:mva)), base_power, operation_cost, powerhouse_elevation, construct_value(HydroTurbine, _construction_fields, Val(:ramp_limits), Val(:mva)), time_limits, outflow_limits, efficiency, turbine_type, conversion_factor, prime_mover_type, travel_time, services, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end

function HydroTurbine(; name, available, bus, active_power, reactive_power, rating, active_power_limits, reactive_power_limits, base_power, operation_cost=HydroGenerationCost(nothing), powerhouse_elevation=0.0, ramp_limits=nothing, time_limits=nothing, outflow_limits=nothing, efficiency=1.0, turbine_type=HydroTurbineType.UNKNOWN, conversion_factor=1.0, prime_mover_type=PrimeMovers.HY, travel_time=nothing, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, base_power = base_power, operation_cost = operation_cost, powerhouse_elevation = powerhouse_elevation, ramp_limits = ramp_limits, time_limits = time_limits, outflow_limits = outflow_limits, efficiency = efficiency, turbine_type = turbine_type, conversion_factor = conversion_factor, prime_mover_type = prime_mover_type, travel_time = travel_time, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    HydroTurbine(name, available, bus, construct_value(HydroTurbine, _construction_fields, Val(:active_power), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:rating), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(HydroTurbine, _construction_fields, Val(:reactive_power_limits), Val(:mva)), base_power, operation_cost, powerhouse_elevation, construct_value(HydroTurbine, _construction_fields, Val(:ramp_limits), Val(:mva)), time_limits, outflow_limits, efficiency, turbine_type, conversion_factor, prime_mover_type, travel_time, services, dynamic_injector, ext, internal, )
end
