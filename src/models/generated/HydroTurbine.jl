...
get_active_power(value::HydroTurbine) = get_value(value, value.active_power, Val(:mva))
"""Get [`HydroTurbine`](@ref) `reactive_power`."""
get_reactive_power(value::HydroTurbine) = get_value(value, value.reactive_power, Val(:mva))
"""Get [`HydroTurbine`](@ref) `rating`."""
get_rating(value::HydroTurbine) = get_value(value, value.rating, Val(:mva))
"""Get [`HydroTurbine`](@ref) `active_power_limits`."""
get_active_power_limits(value::HydroTurbine) = get_value(value, value.active_power_limits, Val(:mva))
"""Get [`HydroTurbine`](@ref) `reactive_power_limits`."""
get_reactive_power_limits(value::HydroTurbine) = get_value(value, value.reactive_power_limits, Val(:mva))
...
get_ramp_limits(value::HydroTurbine) = get_value(value, value.ramp_limits, Val(:mva))
...
set_active_power!(value::HydroTurbine, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`HydroTurbine`](@ref) `reactive_power`."""
set_reactive_power!(value::HydroTurbine, val) = value.reactive_power = set_value(value, val, Val(:mva))
"""Set [`HydroTurbine`](@ref) `rating`."""
set_rating!(value::HydroTurbine, val) = value.rating = set_value(value, val, Val(:mva))
"""Set [`HydroTurbine`](@ref) `active_power_limits`."""
set_active_power_limits!(value::HydroTurbine, val) = value.active_power_limits = set_value(value, val, Val(:mva))
"""Set [`HydroTurbine`](@ref) `reactive_power_limits`."""
set_reactive_power_limits!(value::HydroTurbine, val) = value.reactive_power_limits = set_value(value, val, Val(:mva))
...
set_ramp_limits!(value::HydroTurbine, val) = value.ramp_limits = set_value(value, val, Val(:mva))
