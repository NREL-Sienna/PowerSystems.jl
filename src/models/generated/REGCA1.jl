...
function REGCA1(T_g, Rrpwr, Brkpt, Zerox, Lvpl1, Vo_lim, Lv_pnts, Io_lim, T_fltr, K_hv, Iqr_lims, Accel, Lvpl_sw, Q_ref=1.0, R_source=0.0, X_source=1.0e5, ext=Dict{String, Any}(), )
    REGCA1(T_g, Rrpwr, Brkpt, Zerox, Lvpl1, Vo_lim, Lv_pnts, Io_lim, T_fltr, K_hv, Iqr_lims, Accel, Lvpl_sw, Q_ref, R_source, X_source, ext, [:Ip, :Iq, :Vmeas], 3, )
end

function REGCA1(; T_g, Rrpwr, Brkpt, Zerox, Lvpl1, Vo_lim, Lv_pnts, Io_lim, T_fltr, K_hv, Iqr_lims, Accel, Lvpl_sw, Q_ref=1.0, R_source=0.0, X_source=1.0e5, ext=Dict{String, Any}(), states=[:Ip, :Iq, :Vmeas], n_states=3, )
    REGCA1(T_g, Rrpwr, Brkpt, Zerox, Lvpl1, Vo_lim, Lv_pnts, Io_lim, T_fltr, K_hv, Iqr_lims, Accel, Lvpl_sw, Q_ref, R_source, X_source, ext, states, n_states, )
end
...
"""Get [`REGCA1`](@ref) `R_source`."""
get_R_source(value::REGCA1) = value.R_source
"""Get [`REGCA1`](@ref) `X_source`."""
get_X_source(value::REGCA1) = value.X_source
"""Get [`REGCA1`](@ref) `ext`."""
...
"""Set [`REGCA1`](@ref) `R_source`."""
set_R_source!(value::REGCA1, val) = value.R_source = val
"""Set [`REGCA1`](@ref) `X_source`."""
set_X_source!(value::REGCA1, val) = value.X_source = val
"""Set [`REGCA1`](@ref) `ext`."""
