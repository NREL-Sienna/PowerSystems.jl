...
- `peak_active_power::Float64`: Peak active power in the area
- `peak_reactive_power::Float64`: Peak reactive power in the area
- `load_response::Float64`: Load-frequency damping parameter modeling how much the load in the area changes due to changes in frequency (MW/Hz). [Example here.](https://doi.org/10.1109/NAPS50074.2021.9449687)
