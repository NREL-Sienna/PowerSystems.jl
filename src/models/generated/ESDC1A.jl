...
- `Ke::Float64`: Exciter constant related to self-excited field, validation range: `(0, nothing)`, validation range: `(0, nothing)`
...
- `Kf::Float64`: Excitation control system stabilizer gain, validation range: `("eps()", 0.3)`, validation range: `("eps()", 0.3)`, action if invalid: `error`
- `Tf::Float64`: Excitation control system stabilizer time constant, validation range: `("eps()", nothing)`, validation range: `("eps()", nothing)`, action if invalid: `error`
