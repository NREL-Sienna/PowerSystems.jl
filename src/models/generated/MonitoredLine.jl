...
function MonitoredLine(name, available, active_power_flow, reactive_power_flow, arc, r, x, b, flow_limits, rating, angle_limits, rating_b=nothing, rating_c=nothing, g=(from=0.0, to=0.0), services=Device[], ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, arc = arc, r = r, x = x, b = b, flow_limits = flow_limits, rating = rating, angle_limits = angle_limits, rating_b = rating_b, rating_c = rating_c, g = g, services = services, ext = ext, )
    MonitoredLine(name, available, construct_value(MonitoredLine, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:reactive_power_flow), Val(:mva)), arc, construct_value(MonitoredLine, _construction_fields, Val(:r), Val(:ohm)), construct_value(MonitoredLine, _construction_fields, Val(:x), Val(:ohm)), construct_value(MonitoredLine, _construction_fields, Val(:b), Val(:siemens)), construct_value(MonitoredLine, _construction_fields, Val(:flow_limits), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:rating), Val(:mva)), angle_limits, construct_value(MonitoredLine, _construction_fields, Val(:rating_b), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:rating_c), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:g), Val(:siemens)), services, ext, InfrastructureSystemsInternal(), )
end
...
function MonitoredLine(; name, available, active_power_flow, reactive_power_flow, arc, r, x, b, flow_limits, rating, angle_limits, rating_b=nothing, rating_c=nothing, g=(from=0.0, to=0.0), services=Device[], ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, arc = arc, r = r, x = x, b = b, flow_limits = flow_limits, rating = rating, angle_limits = angle_limits, rating_b = rating_b, rating_c = rating_c, g = g, services = services, ext = ext, )
    MonitoredLine(name, available, construct_value(MonitoredLine, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:reactive_power_flow), Val(:mva)), arc, construct_value(MonitoredLine, _construction_fields, Val(:r), Val(:ohm)), construct_value(MonitoredLine, _construction_fields, Val(:x), Val(:ohm)), construct_value(MonitoredLine, _construction_fields, Val(:b), Val(:siemens)), construct_value(MonitoredLine, _construction_fields, Val(:flow_limits), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:rating), Val(:mva)), angle_limits, construct_value(MonitoredLine, _construction_fields, Val(:rating_b), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:rating_c), Val(:mva)), construct_value(MonitoredLine, _construction_fields, Val(:g), Val(:siemens)), services, ext, internal, )
end
