...
set_R!(value::MarconatoMachine, val::Float64) = value.R = val
"""Set MarconatoMachine Xd."""
set_Xd!(value::MarconatoMachine, val::Float64) = value.Xd = val
"""Set MarconatoMachine Xq."""
set_Xq!(value::MarconatoMachine, val::Float64) = value.Xq = val
"""Set MarconatoMachine Xd_p."""
set_Xd_p!(value::MarconatoMachine, val::Float64) = value.Xd_p = val
"""Set MarconatoMachine Xq_p."""
set_Xq_p!(value::MarconatoMachine, val::Float64) = value.Xq_p = val
"""Set MarconatoMachine Xd_pp."""
set_Xd_pp!(value::MarconatoMachine, val::Float64) = value.Xd_pp = val
"""Set MarconatoMachine Xq_pp."""
set_Xq_pp!(value::MarconatoMachine, val::Float64) = value.Xq_pp = val
"""Set MarconatoMachine Td0_p."""
set_Td0_p!(value::MarconatoMachine, val::Float64) = value.Td0_p = val
"""Set MarconatoMachine Tq0_p."""
set_Tq0_p!(value::MarconatoMachine, val::Float64) = value.Tq0_p = val
"""Set MarconatoMachine Td0_pp."""
set_Td0_pp!(value::MarconatoMachine, val::Float64) = value.Td0_pp = val
...
set_γd!(value::MarconatoMachine, val::Float64) = value.γd = val
"""Set MarconatoMachine γq."""
set_γq!(value::MarconatoMachine, val::Float64) = value.γq = val
"""Set MarconatoMachine states."""
set_states!(value::MarconatoMachine, val::Vector{Symbol}) = value.states = val
"""Set MarconatoMachine n_states."""
set_n_states!(value::MarconatoMachine, val::Int64) = value.n_states = val
"""Set MarconatoMachine internal."""
set_internal!(value::MarconatoMachine, val::InfrastructureSystemsInternal) = value.internal = val
