...
- `Te::Float64`: Exciter field time constant in s, validation range: `("eps()", 2)`, validation range: `("eps()", 2)`, action if invalid: `error`
...
- `Tf::Float64`: Rate feedback time constant, validation range: `("eps()", 1.5)`, validation range: `("eps()", 1.5)`, action if invalid: `error`
