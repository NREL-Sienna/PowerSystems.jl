...
function HydroStorage(name, available, bus, activepower, reactivepower, tech, op_cost, storagecapacity, initial_storage, _forecasts=InfrastructureSystems.Forecasts(), ext=nothing, )
    HydroStorage(name, available, bus, activepower, reactivepower, tech, op_cost, storagecapacity, initial_storage, _forecasts, ext, InfrastructureSystemsInternal())
end

function HydroStorage(; name, available, bus, activepower, reactivepower, tech, op_cost, storagecapacity, initial_storage, _forecasts=InfrastructureSystems.Forecasts(), ext=nothing, )
    HydroStorage(name, available, bus, activepower, reactivepower, tech, op_cost, storagecapacity, initial_storage, _forecasts, ext, )
end


function HydroStorage(name, available, bus, activepower, reactivepower, tech, op_cost, storagecapacity, initial_storage, ; ext=nothing)
    _forecasts=InfrastructureSystems.Forecasts()
    HydroStorage(name, available, bus, activepower, reactivepower, tech, op_cost, storagecapacity, initial_storage, _forecasts, ext, InfrastructureSystemsInternal())
end
