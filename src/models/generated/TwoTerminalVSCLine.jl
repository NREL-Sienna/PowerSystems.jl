...
function TwoTerminalVSCLine(name, available, arc, active_power_flow, rating, active_power_limits_from, active_power_limits_to, g=0.0, dc_current=0.0, reactive_power_from=0.0, dc_control_from=VSCDCControlModes.DC_VOLTAGE, ac_control_from=VSCACControlModes.AC_VOLTAGE, dc_setpoint_from=0.0, ac_setpoint_from=1.0, converter_loss_from=LinearCurve(0.0), max_dc_current_from=1e8, rating_from=1e8, reactive_power_limits_from=(min=0.0, max=0.0), power_factor_weighting_fraction_from=1.0, voltage_limits_from=(min=0.0, max=999.9), dc_voltage_droop_from=0.0, reactive_power_to=0.0, dc_control_to=VSCDCControlModes.DC_VOLTAGE, ac_control_to=VSCACControlModes.AC_VOLTAGE, dc_setpoint_to=0.0, ac_setpoint_to=1.0, converter_loss_to=LinearCurve(0.0), max_dc_current_to=1e8, rating_to=1e8, reactive_power_limits_to=(min=0.0, max=0.0), power_factor_weighting_fraction_to=1.0, voltage_limits_to=(min=0.0, max=999.9), dc_voltage_droop_to=0.0, rated_dc_voltage=0.0, remote_bus_control_from=nothing, remote_bus_control_to=nothing, rmpct_from=100.0, rmpct_to=100.0, services=Device[], base_power=100.0, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, arc = arc, active_power_flow = active_power_flow, rating = rating, active_power_limits_from = active_power_limits_from, active_power_limits_to = active_power_limits_to, g = g, dc_current = dc_current, reactive_power_from = reactive_power_from, dc_control_from = dc_control_from, ac_control_from = ac_control_from, dc_setpoint_from = dc_setpoint_from, ac_setpoint_from = ac_setpoint_from, converter_loss_from = converter_loss_from, max_dc_current_from = max_dc_current_from, rating_from = rating_from, reactive_power_limits_from = reactive_power_limits_from, power_factor_weighting_fraction_from = power_factor_weighting_fraction_from, voltage_limits_from = voltage_limits_from, dc_voltage_droop_from = dc_voltage_droop_from, reactive_power_to = reactive_power_to, dc_control_to = dc_control_to, ac_control_to = ac_control_to, dc_setpoint_to = dc_setpoint_to, ac_setpoint_to = ac_setpoint_to, converter_loss_to = converter_loss_to, max_dc_current_to = max_dc_current_to, rating_to = rating_to, reactive_power_limits_to = reactive_power_limits_to, power_factor_weighting_fraction_to = power_factor_weighting_fraction_to, voltage_limits_to = voltage_limits_to, dc_voltage_droop_to = dc_voltage_droop_to, rated_dc_voltage = rated_dc_voltage, remote_bus_control_from = remote_bus_control_from, remote_bus_control_to = remote_bus_control_to, rmpct_from = rmpct_from, rmpct_to = rmpct_to, services = services, base_power = base_power, ext = ext, )
    TwoTerminalVSCLine(name, available, arc, construct_value(TwoTerminalVSCLine, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(TwoTerminalVSCLine, _construction_fields, Val(:rating), Val(:mva)), construct_value(TwoTerminalVSCLine, _construction_fields, Val(:active_power_limits_from), Val(:mva)), construct_value(TwoTerminalVSCLine, _construction_fields, Val(:active_power_limits_to), Val(:mva)), g, dc_current, construct_value(TwoTerminalVSCLine, _construction_fields, Val(:reactive_power_from), Val(:mva)), dc_control_from, ac_control_from, dc_setpoint_from, ac_setpoint_from, converter_loss_from, max_dc_current_from, construct_value(TwoTerminalVSCLine, _construction_fields, Val(:rating_from), Val(:mva)), construct_value(TwoTerminalVSCLine, _construction_fields, Val(:reactive_power_limits_from), Val(:mva)), power_factor_weighting_fraction_from, voltage_limits_from, dc_voltage_droop_from, construct_value(TwoTerminalVSCLine, _construction_fields, Val(:reactive_power_to), Val(:mva)), dc_control_to, ac_control_to, dc_setpoint_to, ac_setpoint_to, converter_loss_to, max_dc_current_to, construct_value(TwoTerminalVSCLine, _construction_fields, Val(:rating_to), Val(:mva)), construct_value(TwoTerminalVSCLine, _construction_fields, Val(:reactive_power_limits_to), Val(:mva)), power_factor_weighting_fraction_to, voltage_limits_to, dc_voltage_droop_to, rated_dc_voltage, remote_bus_control_from, remote_bus_control_to, rmpct_from, rmpct_to, services, base_power, ext, InfrastructureSystemsInternal(), )
end

function TwoTerminalVSCLine(; name, available, arc, active_power_flow, rating, active_power_limits_from, active_power_limits_to, g=0.0, dc_current=0.0, reactive_power_from=0.0, dc_control_from=VSCDCControlModes.DC_VOLTAGE, ac_control_from=VSCACControlModes.AC_VOLTAGE, dc_setpoint_from=0.0, ac_setpoint_from=1.0, converter_loss_from=LinearCurve(0.0), max_dc_current_from=1e8, rating_from=1e8, reactive_power_limits_from=(min=0.0, max=0.0), power_factor_weighting_fraction_from=1.0, voltage_limits_from=(min=0.0, max=999.9), dc_voltage_droop_from=0.0, reactive_power_to=0.0, dc_control_to=VSCDCControlModes.DC_VOLTAGE, ac_control_to=VSCACControlModes.AC_VOLTAGE, dc_setpoint_to=0.0, ac_setpoint_to=1.0, converter_loss_to=LinearCurve(0.0), max_dc_current_to=1e8, rating_to=1e8, reactive_power_limits_to=(min=0.0, max=0.0), power_factor_weighting_fraction_to=1.0, voltage_limits_to=(min=0.0, max=999.9), dc_voltage_droop_to=0.0, rated_dc_voltage=0.0, remote_bus_control_from=nothing, remote_bus_control_to=nothing, rmpct_from=100.0, rmpct_to=100.0, services=Device[], base_power=100.0, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, arc = arc, active_power_flow = active_power_flow, rating = rating, active_power_limits_from = active_power_limits_from, active_power_limits_to = active_power_limits_to, g = g, dc_current = dc_current, reactive_power_from = reactive_power_from, dc_control_from = dc_control_from, ac_control_from = ac_control_from, dc_setpoint_from = dc_setpoint_from, ac_setpoint_from = ac_setpoint_from, converter_loss_from = converter_loss_from, max_dc_current_from = max_dc_current_from, rating_from = rating_from, reactive_power_limits_from = reactive_power_limits_from, power_factor_weighting_fraction_from = power_factor_weighting_fraction_from, voltage_limits_from = voltage_limits_from, dc_voltage_droop_from = dc_voltage_droop_from, reactive_power_to = reactive_power_to, dc_control_to = dc_control_to, ac_control_to = ac_control_to, dc_setpoint_to = dc_setpoint_to, ac_setpoint_to = ac_setpoint_to, converter_loss_to = converter_loss_to, max_dc_current_to = max_dc_current_to, rating_to = rating_to, reactive_power_limits_to = reactive_power_limits_to, power_factor_weighting_fraction_to = power_factor_weighting_fraction_to, voltage_limits_to = voltage_limits_to, dc_voltage_droop_to = dc_voltage_droop_to, rated_dc_voltage = rated_dc_voltage, remote_bus_control_from = remote_bus_control_from, remote_bus_control_to = remote_bus_control_to, rmpct_from = rmpct_from, rmpct_to = rmpct_to, services = services, base_power = base_power, ext = ext, )
...
"""Get [`TwoTerminalVSCLine`](@ref) `rating_from` as a bare number in the requested `units` (e.g. `SU`, `DU`; domain-provided units such as `MW` are also accepted when the owning domain package has registered a `_strip_units` method for the returned quantity type). Returns a bare number only when such a method is registered; otherwise returns the quantity wrapper. For the unit-bearing value see [`get_rating_from_unitful`](@ref)."""
...
"""Get [`TwoTerminalVSCLine`](@ref) `rating_to` as a bare number in the requested `units` (e.g. `SU`, `DU`; domain-provided units such as `MW` are also accepted when the owning domain package has registered a `_strip_units` method for the returned quantity type). Returns a bare number only when such a method is registered; otherwise returns the quantity wrapper. For the unit-bearing value see [`get_rating_to_unitful`](@ref)."""
...
"""Get [`TwoTerminalVSCLine`](@ref) `rated_dc_voltage`."""
get_rated_dc_voltage(value::TwoTerminalVSCLine) = value.rated_dc_voltage
"""Get [`TwoTerminalVSCLine`](@ref) `remote_bus_control_from`."""
...
"""Set [`TwoTerminalVSCLine`](@ref) `rated_dc_voltage`."""
set_rated_dc_voltage!(value::TwoTerminalVSCLine, val) = value.rated_dc_voltage = val
"""Set [`TwoTerminalVSCLine`](@ref) `remote_bus_control_from`."""
