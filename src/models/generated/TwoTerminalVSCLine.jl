...
get_active_power_flow(value::TwoTerminalVSCLine) = get_value(value, value.active_power_flow, Val(:mva))
"""Get [`TwoTerminalVSCLine`](@ref) `rating`."""
get_rating(value::TwoTerminalVSCLine) = get_value(value, value.rating, Val(:mva))
"""Get [`TwoTerminalVSCLine`](@ref) `active_power_limits_from`."""
get_active_power_limits_from(value::TwoTerminalVSCLine) = get_value(value, value.active_power_limits_from, Val(:mva))
"""Get [`TwoTerminalVSCLine`](@ref) `active_power_limits_to`."""
get_active_power_limits_to(value::TwoTerminalVSCLine) = get_value(value, value.active_power_limits_to, Val(:mva))
...
get_reactive_power_from(value::TwoTerminalVSCLine) = get_value(value, value.reactive_power_from, Val(:mva))
...
get_rating_from(value::TwoTerminalVSCLine) = get_value(value, value.rating_from, Val(:mva))
...
get_reactive_power_to(value::TwoTerminalVSCLine) = get_value(value, value.reactive_power_to, Val(:mva))
...
set_active_power_flow!(value::TwoTerminalVSCLine, val) = value.active_power_flow = set_value(value, val, Val(:mva))
"""Set [`TwoTerminalVSCLine`](@ref) `rating`."""
set_rating!(value::TwoTerminalVSCLine, val) = value.rating = set_value(value, val, Val(:mva))
"""Set [`TwoTerminalVSCLine`](@ref) `active_power_limits_from`."""
set_active_power_limits_from!(value::TwoTerminalVSCLine, val) = value.active_power_limits_from = set_value(value, val, Val(:mva))
"""Set [`TwoTerminalVSCLine`](@ref) `active_power_limits_to`."""
set_active_power_limits_to!(value::TwoTerminalVSCLine, val) = value.active_power_limits_to = set_value(value, val, Val(:mva))
...
set_reactive_power_from!(value::TwoTerminalVSCLine, val) = value.reactive_power_from = set_value(value, val, Val(:mva))
...
set_rating_from!(value::TwoTerminalVSCLine, val) = value.rating_from = set_value(value, val, Val(:mva))
...
set_reactive_power_to!(value::TwoTerminalVSCLine, val) = value.reactive_power_to = set_value(value, val, Val(:mva))
