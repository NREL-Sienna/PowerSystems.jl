...
- `V_ref::Float64`: User defined voltage reference. If 0, [`PowerSimulationsDynamics.jl`](https://nrel-sienna.github.io/PowerSimulationsDynamics.jl/stable/) initializes to initial terminal voltage, validation range: `(0, nothing)`
- `Pfa_ref::Float64`: Reference power factor, validation range: `(0, nothing)`
- `ω_ref::Float64`: Reference Frequency (pu), validation range: `(0, nothing)`
...
- `base_power::Float64`: Base power (MVA) for per unitization
