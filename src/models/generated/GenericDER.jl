...
"""
    mutable struct GenericDER <: DynamicInjection
        ...
        Kpq::Float64
        Kiq::Float64
        Iqr_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}
        I_max::Float64
        Tg::Float64
        kWh_Cap::Float64
        SOC_ini::Float64
        ...
        tV_delay::Float64
        VES_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}
...
- `Q_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}`: Reactive power limits in pu (Q_min, Q_max)
- `Tp::Float64`: Power measurement transducer's time constant, in s, validation range: `(0, nothing)`
- `e_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}`: Error limit in PI controller for q control (e_min, e_max)
...
- `Iqr_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}`: Limit on rate of change for reactive current (pu/s) (Iqr_min, Iqr_max)
...
- `P_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}`: Active power limits in pu (P_min, P_max)
- `dP_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}`: Ramp rate limits for active power in pu/s (dP_min, dP_max)
...
- `VES_lim::NamedTuple{(:min, :max), Tuple{Float64, Float64}}`: Min and max voltage for entering service (VES_min,VES_max)
