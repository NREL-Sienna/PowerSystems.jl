...
- `dc_current::Float64`: DC current (A) on the converter
- `max_dc_current::Float64`: Maximum stable dc current limits (A)
...
function InterconnectingConverter(name, available, bus, dc_bus, active_power, rating, active_power_limits, dc_current, max_dc_current, base_power, loss_function=LinearCurve(0.0), services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), )
    InterconnectingConverter(name, available, bus, dc_bus, active_power, rating, active_power_limits, dc_current, max_dc_current, base_power, loss_function, services, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end

function InterconnectingConverter(; name, available, bus, dc_bus, active_power, rating, active_power_limits, dc_current, max_dc_current, base_power, loss_function=LinearCurve(0.0), services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    InterconnectingConverter(name, available, bus, dc_bus, active_power, rating, active_power_limits, dc_current, max_dc_current, base_power, loss_function, services, dynamic_injector, ext, internal, )
end
