...
- `efficiency::Float64`: (default: `1.0`) (optional) Conversion efficiency [0, 1.0] from AC Power to DC Power
...
mutable struct InterconnectingConverter <: StaticInjection
    ...
    base_power::Float64
    "(optional) Conversion efficiency [0, 1.0] from AC Power to DC Power"
    efficiency::Float64
