...
function ConstantReserve{T}(name, available, time_frame, requirement, sustained_time=60.0, max_output_fraction=1.0, max_participation_factor=1.0, deployed_fraction=0.0, ext=Dict{String, Any}(), ) where T <: ReserveDirection
...
function ConstantReserve{T}(; name, available, time_frame, requirement, sustained_time=60.0, max_output_fraction=1.0, max_participation_factor=1.0, deployed_fraction=0.0, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), ) where T <: ReserveDirection
...
InfrastructureSystems.display_units_arg(::typeof(get_requirement), ::Type{ConstantReserve{T}}) where {T <: ReserveDirection} = InfrastructureSystems.SU
InfrastructureSystems.display_units_arg(::typeof(get_requirement_unitful), ::Type{ConstantReserve{T}}) where {T <: ReserveDirection} = InfrastructureSystems.SU
