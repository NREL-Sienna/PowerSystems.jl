...
get_requirement(value::ConstantReserve) = get_value(value, value.requirement, Val(:mva))
...
set_requirement!(value::ConstantReserve, val) = value.requirement = set_value(value, val, Val(:mva))
