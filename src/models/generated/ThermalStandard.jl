...
function ThermalStandard(name, available, status, bus, active_power, reactive_power, rating, active_power_limits, reactive_power_limits, ramp_limits, operation_cost, base_power, time_limits=nothing, must_run=false, prime_mover_type=PrimeMovers.OT, fuel=ThermalFuels.OTHER, services=Device[], time_at_status=INFINITE_TIME, dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, status = status, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, ramp_limits = ramp_limits, operation_cost = operation_cost, base_power = base_power, time_limits = time_limits, must_run = must_run, prime_mover_type = prime_mover_type, fuel = fuel, services = services, time_at_status = time_at_status, dynamic_injector = dynamic_injector, ext = ext, )
    ThermalStandard(name, available, status, bus, construct_value(ThermalStandard, _construction_fields, Val(:active_power), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:rating), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:reactive_power_limits), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:ramp_limits), Val(:mva)), operation_cost, base_power, time_limits, must_run, prime_mover_type, fuel, services, time_at_status, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end

function ThermalStandard(; name, available, status, bus, active_power, reactive_power, rating, active_power_limits, reactive_power_limits, ramp_limits, operation_cost, base_power, time_limits=nothing, must_run=false, prime_mover_type=PrimeMovers.OT, fuel=ThermalFuels.OTHER, services=Device[], time_at_status=INFINITE_TIME, dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, status = status, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, ramp_limits = ramp_limits, operation_cost = operation_cost, base_power = base_power, time_limits = time_limits, must_run = must_run, prime_mover_type = prime_mover_type, fuel = fuel, services = services, time_at_status = time_at_status, dynamic_injector = dynamic_injector, ext = ext, )
    ThermalStandard(name, available, status, bus, construct_value(ThermalStandard, _construction_fields, Val(:active_power), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:rating), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:reactive_power_limits), Val(:mva)), construct_value(ThermalStandard, _construction_fields, Val(:ramp_limits), Val(:mva)), operation_cost, base_power, time_limits, must_run, prime_mover_type, fuel, services, time_at_status, dynamic_injector, ext, internal, )
end
