...
function TwoTerminalLCCLine(; name, available, arc, active_power_flow, r, transfer_setpoint, scheduled_dc_voltage, rectifier_bridges, rectifier_delay_angle_limits, rectifier_rc, rectifier_xc, rectifier_base_voltage, inverter_bridges, inverter_extinction_angle_limits, inverter_rc, inverter_xc, inverter_base_voltage, power_mode=true, switch_mode_voltage=0.0, compounding_resistance=0.0, min_compounding_voltage=0.0, rectifier_transformer_ratio=1.0, rectifier_tap_setting=1.0, rectifier_tap_limits=(min=0.51, max=1.5), rectifier_tap_step=0.00625, rectifier_delay_angle=0.0, rectifier_capacitor_reactance=0.0, inverter_transformer_ratio=1.0, inverter_tap_setting=1.0, inverter_tap_limits=(min=0.51, max=1.5), inverter_tap_step=0.00625, inverter_extinction_angle=0.0, inverter_capacitor_reactance=0.0, active_power_limits_from=(min=0.0, max=0.0), active_power_limits_to=(min=0.0, max=0.0), reactive_power_limits_from=(min=0.0, max=0.0), reactive_power_limits_to=(min=0.0, max=0.0), loss=LinearCurve(0.0), services=Device[], ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, arc = arc, active_power_flow = active_power_flow, r = r, transfer_setpoint = transfer_setpoint, scheduled_dc_voltage = scheduled_dc_voltage, rectifier_bridges = rectifier_bridges, rectifier_delay_angle_limits = rectifier_delay_angle_limits, rectifier_rc = rectifier_rc, rectifier_xc = rectifier_xc, rectifier_base_voltage = rectifier_base_voltage, inverter_bridges = inverter_bridges, inverter_extinction_angle_limits = inverter_extinction_angle_limits, inverter_rc = inverter_rc, inverter_xc = inverter_xc, inverter_base_voltage = inverter_base_voltage, power_mode = power_mode, switch_mode_voltage = switch_mode_voltage, compounding_resistance = compounding_resistance, min_compounding_voltage = min_compounding_voltage, rectifier_transformer_ratio = rectifier_transformer_ratio, rectifier_tap_setting = rectifier_tap_setting, rectifier_tap_limits = rectifier_tap_limits, rectifier_tap_step = rectifier_tap_step, rectifier_delay_angle = rectifier_delay_angle, rectifier_capacitor_reactance = rectifier_capacitor_reactance, inverter_transformer_ratio = inverter_transformer_ratio, inverter_tap_setting = inverter_tap_setting, inverter_tap_limits = inverter_tap_limits, inverter_tap_step = inverter_tap_step, inverter_extinction_angle = inverter_extinction_angle, inverter_capacitor_reactance = inverter_capacitor_reactance, active_power_limits_from = active_power_limits_from, active_power_limits_to = active_power_limits_to, reactive_power_limits_from = reactive_power_limits_from, reactive_power_limits_to = reactive_power_limits_to, loss = loss, services = services, ext = ext, )
    TwoTerminalLCCLine(name, available, arc, construct_value(TwoTerminalLCCLine, _construction_fields, Val(:active_power_flow), Val(:mva)), r, transfer_setpoint, scheduled_dc_voltage, rectifier_bridges, rectifier_delay_angle_limits, rectifier_rc, rectifier_xc, rectifier_base_voltage, inverter_bridges, inverter_extinction_angle_limits, inverter_rc, inverter_xc, inverter_base_voltage, power_mode, switch_mode_voltage, compounding_resistance, min_compounding_voltage, rectifier_transformer_ratio, rectifier_tap_setting, rectifier_tap_limits, rectifier_tap_step, rectifier_delay_angle, rectifier_capacitor_reactance, inverter_transformer_ratio, inverter_tap_setting, inverter_tap_limits, inverter_tap_step, inverter_extinction_angle, inverter_capacitor_reactance, construct_value(TwoTerminalLCCLine, _construction_fields, Val(:active_power_limits_from), Val(:mva)), construct_value(TwoTerminalLCCLine, _construction_fields, Val(:active_power_limits_to), Val(:mva)), construct_value(TwoTerminalLCCLine, _construction_fields, Val(:reactive_power_limits_from), Val(:mva)), construct_value(TwoTerminalLCCLine, _construction_fields, Val(:reactive_power_limits_to), Val(:mva)), loss, services, ext, internal, )
end
