...
export get_Zerox
export get_a
export get_ac_control
export get_ac_control_from
export get_ac_control_to
export get_ac_setpoint
...
export get_active_power_pump_unitful
export get_active_power_unitful
...
export get_current_active_power_unitful
export get_current_reactive_power
export get_current_reactive_power_unitful
...
export get_flow_limits_unitful
...
export get_impedance_active_power_unitful
export get_impedance_reactive_power
export get_impedance_reactive_power_unitful
export get_inflow
...
export get_output_active_power_limits_unitful
...
export get_reactive_power_limits_from_unitful
export get_reactive_power_limits_to
export get_reactive_power_limits_to_unitful
export get_reactive_power_limits_unitful
export get_reactive_power_required
export get_reactive_power_to
export get_reactive_power_to_unitful
export get_reactive_power_unitful
...
export set_Zerox!
export set_a!
export set_ac_control!
export set_ac_control_from!
export set_ac_control_to!
export set_ac_setpoint!
