...
function HybridSystem(name, available, status, bus, active_power=0.0, reactive_power=0.0, base_power=100.0, operation_cost=MarketBidCost(nothing), thermal_unit=nothing, electric_load=nothing, storage=nothing, renewable_unit=nothing, interconnection_impedance=0.0, interconnection_rating=nothing, input_active_power_limits=nothing, output_active_power_limits=nothing, reactive_power_limits=nothing, interconnection_efficiency=nothing, services=Service[], dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, status = status, bus = bus, active_power = active_power, reactive_power = reactive_power, base_power = base_power, operation_cost = operation_cost, thermal_unit = thermal_unit, electric_load = electric_load, storage = storage, renewable_unit = renewable_unit, interconnection_impedance = interconnection_impedance, interconnection_rating = interconnection_rating, input_active_power_limits = input_active_power_limits, output_active_power_limits = output_active_power_limits, reactive_power_limits = reactive_power_limits, interconnection_efficiency = interconnection_efficiency, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    HybridSystem(name, available, status, bus, construct_value(HybridSystem, _construction_fields, Val(:active_power), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:reactive_power), Val(:mva)), base_power, operation_cost, thermal_unit, electric_load, storage, renewable_unit, interconnection_impedance, construct_value(HybridSystem, _construction_fields, Val(:interconnection_rating), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:input_active_power_limits), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:output_active_power_limits), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:reactive_power_limits), Val(:mva)), interconnection_efficiency, services, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end
...
function HybridSystem(; name, available, status, bus, active_power=0.0, reactive_power=0.0, base_power=100.0, operation_cost=MarketBidCost(nothing), thermal_unit=nothing, electric_load=nothing, storage=nothing, renewable_unit=nothing, interconnection_impedance=0.0, interconnection_rating=nothing, input_active_power_limits=nothing, output_active_power_limits=nothing, reactive_power_limits=nothing, interconnection_efficiency=nothing, services=Service[], dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, status = status, bus = bus, active_power = active_power, reactive_power = reactive_power, base_power = base_power, operation_cost = operation_cost, thermal_unit = thermal_unit, electric_load = electric_load, storage = storage, renewable_unit = renewable_unit, interconnection_impedance = interconnection_impedance, interconnection_rating = interconnection_rating, input_active_power_limits = input_active_power_limits, output_active_power_limits = output_active_power_limits, reactive_power_limits = reactive_power_limits, interconnection_efficiency = interconnection_efficiency, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    HybridSystem(name, available, status, bus, construct_value(HybridSystem, _construction_fields, Val(:active_power), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:reactive_power), Val(:mva)), base_power, operation_cost, thermal_unit, electric_load, storage, renewable_unit, interconnection_impedance, construct_value(HybridSystem, _construction_fields, Val(:interconnection_rating), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:input_active_power_limits), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:output_active_power_limits), Val(:mva)), construct_value(HybridSystem, _construction_fields, Val(:reactive_power_limits), Val(:mva)), interconnection_efficiency, services, dynamic_injector, ext, internal, )
end
