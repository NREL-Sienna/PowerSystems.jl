...
get_peak_active_power(value::LoadZone) = get_value(value, value.peak_active_power, Val(:mva))
"""Get [`LoadZone`](@ref) `peak_reactive_power`."""
get_peak_reactive_power(value::LoadZone) = get_value(value, value.peak_reactive_power, Val(:mva))
...
set_peak_active_power!(value::LoadZone, val) = value.peak_active_power = set_value(value, val, Val(:mva))
"""Set [`LoadZone`](@ref) `peak_reactive_power`."""
set_peak_reactive_power!(value::LoadZone, val) = value.peak_reactive_power = set_value(value, val, Val(:mva))
