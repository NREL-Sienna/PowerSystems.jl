...
- `Ta::Float64`: Regulator output time constant in s, validation range: `(0, 10)`, validation range: `(0, 10)`
...
- `Ke::Float64`: Exciter field proportional constant, validation range: `(0, 1)`, validation range: `(0, 1)`
...
"""Set [`EXAC1A`](@ref) `internal`."""
set_internal!(value::EXAC1A, val) = value.internal = val
