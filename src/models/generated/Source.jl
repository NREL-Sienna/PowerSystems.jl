...
function Source(name, available, bus, active_power=0.0, reactive_power=0.0, active_power_limits=(min=0.0, max=0.0), reactive_power_limits=(min=0.0, max=0.0), R_th=0.0, X_th=0.0, internal_voltage=1.0, internal_angle=0.0, base_power=100.0, operation_cost=ImportExportCost(nothing), dynamic_injector=nothing, services=Device[], ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, reactive_power = reactive_power, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, R_th = R_th, X_th = X_th, internal_voltage = internal_voltage, internal_angle = internal_angle, base_power = base_power, operation_cost = operation_cost, dynamic_injector = dynamic_injector, services = services, ext = ext, )
    Source(name, available, bus, construct_value(Source, _construction_fields, Val(:active_power), Val(:mva)), construct_value(Source, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(Source, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(Source, _construction_fields, Val(:reactive_power_limits), Val(:mva)), R_th, X_th, internal_voltage, internal_angle, base_power, operation_cost, dynamic_injector, services, ext, InfrastructureSystemsInternal(), )
end
...
function Source(; name, available, bus, active_power=0.0, reactive_power=0.0, active_power_limits=(min=0.0, max=0.0), reactive_power_limits=(min=0.0, max=0.0), R_th=0.0, X_th=0.0, internal_voltage=1.0, internal_angle=0.0, base_power=100.0, operation_cost=ImportExportCost(nothing), dynamic_injector=nothing, services=Device[], ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, reactive_power = reactive_power, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, R_th = R_th, X_th = X_th, internal_voltage = internal_voltage, internal_angle = internal_angle, base_power = base_power, operation_cost = operation_cost, dynamic_injector = dynamic_injector, services = services, ext = ext, )
    Source(name, available, bus, construct_value(Source, _construction_fields, Val(:active_power), Val(:mva)), construct_value(Source, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(Source, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(Source, _construction_fields, Val(:reactive_power_limits), Val(:mva)), R_th, X_th, internal_voltage, internal_angle, base_power, operation_cost, dynamic_injector, services, ext, internal, )
end
