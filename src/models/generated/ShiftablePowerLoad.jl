...
get_active_power_limits(value::ShiftablePowerLoad) = get_value(value, value.active_power_limits)
...
set_active_power_limits!(value::ShiftablePowerLoad, val) = value.active_power_limits = set_value(value, val)
