...
get_active_power(value::ShiftablePowerLoad) = get_value(value, value.active_power, Val(:mva))
"""Get [`ShiftablePowerLoad`](@ref) `upper_bound_active_power`."""
get_upper_bound_active_power(value::ShiftablePowerLoad) = get_value(value, value.upper_bound_active_power, Val(:mva))
"""Get [`ShiftablePowerLoad`](@ref) `lower_bound_active_power`."""
get_lower_bound_active_power(value::ShiftablePowerLoad) = get_value(value, value.lower_bound_active_power, Val(:mva))
"""Get [`ShiftablePowerLoad`](@ref) `reactive_power`."""
get_reactive_power(value::ShiftablePowerLoad) = get_value(value, value.reactive_power, Val(:mva))
"""Get [`ShiftablePowerLoad`](@ref) `max_active_power`."""
get_max_active_power(value::ShiftablePowerLoad) = get_value(value, value.max_active_power, Val(:mva))
"""Get [`ShiftablePowerLoad`](@ref) `max_reactive_power`."""
get_max_reactive_power(value::ShiftablePowerLoad) = get_value(value, value.max_reactive_power, Val(:mva))
...
set_active_power!(value::ShiftablePowerLoad, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`ShiftablePowerLoad`](@ref) `upper_bound_active_power`."""
set_upper_bound_active_power!(value::ShiftablePowerLoad, val) = value.upper_bound_active_power = set_value(value, val, Val(:mva))
"""Set [`ShiftablePowerLoad`](@ref) `lower_bound_active_power`."""
set_lower_bound_active_power!(value::ShiftablePowerLoad, val) = value.lower_bound_active_power = set_value(value, val, Val(:mva))
"""Set [`ShiftablePowerLoad`](@ref) `reactive_power`."""
set_reactive_power!(value::ShiftablePowerLoad, val) = value.reactive_power = set_value(value, val, Val(:mva))
"""Set [`ShiftablePowerLoad`](@ref) `max_active_power`."""
set_max_active_power!(value::ShiftablePowerLoad, val) = value.max_active_power = set_value(value, val, Val(:mva))
"""Set [`ShiftablePowerLoad`](@ref) `max_reactive_power`."""
set_max_reactive_power!(value::ShiftablePowerLoad, val) = value.max_reactive_power = set_value(value, val, Val(:mva))
