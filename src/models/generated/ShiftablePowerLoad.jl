...
function ShiftablePowerLoad(name, available, bus, active_power, active_power_limits, reactive_power, max_active_power, max_reactive_power, base_power, load_balance_time_horizon, operation_cost, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, active_power_limits = active_power_limits, reactive_power = reactive_power, max_active_power = max_active_power, max_reactive_power = max_reactive_power, base_power = base_power, load_balance_time_horizon = load_balance_time_horizon, operation_cost = operation_cost, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    ShiftablePowerLoad(name, available, bus, construct_value(ShiftablePowerLoad, _construction_fields, Val(:active_power), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:max_active_power), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:max_reactive_power), Val(:mva)), base_power, load_balance_time_horizon, operation_cost, services, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end
...
function ShiftablePowerLoad(; name, available, bus, active_power, active_power_limits, reactive_power, max_active_power, max_reactive_power, base_power, load_balance_time_horizon, operation_cost, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, active_power_limits = active_power_limits, reactive_power = reactive_power, max_active_power = max_active_power, max_reactive_power = max_reactive_power, base_power = base_power, load_balance_time_horizon = load_balance_time_horizon, operation_cost = operation_cost, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    ShiftablePowerLoad(name, available, bus, construct_value(ShiftablePowerLoad, _construction_fields, Val(:active_power), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:max_active_power), Val(:mva)), construct_value(ShiftablePowerLoad, _construction_fields, Val(:max_reactive_power), Val(:mva)), base_power, load_balance_time_horizon, operation_cost, services, dynamic_injector, ext, internal, )
end
