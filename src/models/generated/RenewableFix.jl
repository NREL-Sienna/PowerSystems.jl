...
function RenewableFix(name, available, bus, activepower, reactivepower, rating, primemover, powerfactor, machine_basepower, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), forecasts=InfrastructureSystems.Forecasts(), )
    RenewableFix(name, available, bus, activepower, reactivepower, rating, primemover, powerfactor, machine_basepower, services, dynamic_injector, ext, forecasts, InfrastructureSystemsInternal(), )
end

function RenewableFix(; name, available, bus, activepower, reactivepower, rating, primemover, powerfactor, machine_basepower, services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), forecasts=InfrastructureSystems.Forecasts(), )
    RenewableFix(name, available, bus, activepower, reactivepower, rating, primemover, powerfactor, machine_basepower, services, dynamic_injector, ext, forecasts, )
end
...
"""Get RenewableFix machine_basepower."""
get_machine_basepower(value::RenewableFix) = value.machine_basepower
...
"""Set RenewableFix machine_basepower."""
set_machine_basepower!(value::RenewableFix, val::Float64) = value.machine_basepower = val
