...
function ESST1A(; UEL_flags, PSS_flags, Tr, Vi_lim, Tc, Tb, Tc1, Tb1, Ka, Ta, Va_lim, Vr_lim, Kc, Kf, Tf, K_lr, I_lr, V_ref=1.0, ext=Dict{String, Any}(), )
    ESST1A(UEL_flags, PSS_flags, Tr, Vi_lim, Tc, Tb, Tc1, Tb1, Ka, Ta, Va_lim, Vr_lim, Kc, Kf, Tf, K_lr, I_lr, V_ref, ext, )
end
...
set_UEL_flags!(value::ESST1A, val::Int) = value.UEL_flags = val
"""Set ESST1A PSS_flags."""
set_PSS_flags!(value::ESST1A, val::Int) = value.PSS_flags = val
"""Set ESST1A Tr."""
set_Tr!(value::ESST1A, val::Float64) = value.Tr = val
"""Set ESST1A Vi_lim."""
set_Vi_lim!(value::ESST1A, val::Tuple{Float64, Float64}) = value.Vi_lim = val
"""Set ESST1A Tc."""
set_Tc!(value::ESST1A, val::Float64) = value.Tc = val
"""Set ESST1A Tb."""
set_Tb!(value::ESST1A, val::Float64) = value.Tb = val
"""Set ESST1A Tc1."""
set_Tc1!(value::ESST1A, val::Float64) = value.Tc1 = val
"""Set ESST1A Tb1."""
set_Tb1!(value::ESST1A, val::Float64) = value.Tb1 = val
"""Set ESST1A Ka."""
set_Ka!(value::ESST1A, val::Float64) = value.Ka = val
"""Set ESST1A Ta."""
set_Ta!(value::ESST1A, val::Float64) = value.Ta = val
"""Set ESST1A Va_lim."""
set_Va_lim!(value::ESST1A, val::Tuple{Float64, Float64}) = value.Va_lim = val
"""Set ESST1A Vr_lim."""
set_Vr_lim!(value::ESST1A, val::Tuple{Float64, Float64}) = value.Vr_lim = val
"""Set ESST1A Kc."""
set_Kc!(value::ESST1A, val::Float64) = value.Kc = val
"""Set ESST1A Kf."""
set_Kf!(value::ESST1A, val::Float64) = value.Kf = val
"""Set ESST1A Tf."""
set_Tf!(value::ESST1A, val::Float64) = value.Tf = val
"""Set ESST1A K_lr."""
set_K_lr!(value::ESST1A, val::Float64) = value.K_lr = val
"""Set ESST1A I_lr."""
set_I_lr!(value::ESST1A, val::Float64) = value.I_lr = val
"""Set ESST1A V_ref."""
set_V_ref!(value::ESST1A, val::Float64) = value.V_ref = val
"""Set ESST1A ext."""
set_ext!(value::ESST1A, val::Dict{String, Any}) = value.ext = val
"""Set ESST1A states."""
set_states!(value::ESST1A, val::Vector{Symbol}) = value.states = val
"""Set ESST1A n_states."""
set_n_states!(value::ESST1A, val::Int) = value.n_states = val
"""Set ESST1A states_types."""
set_states_types!(value::ESST1A, val::Vector{StateTypes.StateType}) = value.states_types = val
"""Set ESST1A internal."""
set_internal!(value::ESST1A, val::InfrastructureSystemsInternal) = value.internal = val
