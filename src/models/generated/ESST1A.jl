...
# Arguments
- `UEL_flags::Int`: Code input for Underexcitization limiter (UEL) entry. Not supported., validation range: `(1, 3)`, validation range: `(1, 3)`, action if invalid: `warn`
- `PSS_flags::Int`: Code input for Power System Stabilizer (PSS) or (VOS) entry., validation range: `(1, 2)`, validation range: `(1, 2)`
- `Tr::Float64`: Regulator input filter time constant in s, validation range: `(0, 0.1)`, validation range: `(0, 0.1)`, action if invalid: `warn`
- `Vi_lim::Tuple{Float64, Float64}`: Voltage error limits (regulator input) (Vi_min, Vi_max)
- `Tc::Float64`: First regulator denominator (lead) time constant in s, validation range: `(0, 10)`, validation range: `(0, 10)`, action if invalid: `warn`
- `Tb::Float64`: First regulator denominator (lag) time constant in s, validation range: `(0, 20)`, validation range: `(0, 20)`
- `Tc1::Float64`: Second regulator denominator (lead) time constant in s, validation range: `(0, 10)`, validation range: `(0, 10)`, action if invalid: `warn`
- `Tb1::Float64`: Second regulator denominator (lead) time constant in s, validation range: `(0, 20)`, validation range: `(0, 20)`, action if invalid: `warn`
- `Ka::Float64`: Voltage regulator gain, validation range: `(50, 1000)`, validation range: `(50, 1000)`, action if invalid: `warn`
- `Ta::Float64`: Voltage regulator time constant in s, validation range: `(0, 0.5)`, validation range: `(0, 0.5)`, action if invalid: `warn`
...
- `Kc::Float64`: Rectifier loading factor proportional to commutating reactance, validation range: `(0, 0.3)`, validation range: `(0, 0.3)`, action if invalid: `warn`
- `Kf::Float64`: Rate feedback gain, validation range: `(0, 0.3)`, validation range: `(0, 0.3)`, action if invalid: `warn`
- `Tf::Float64`: Rate feedback time constant in s, validation range: `("eps()", 1.5)`, validation range: `("eps()", 1.5)`, action if invalid: `error`
- `K_lr::Float64`: Exciter output current limiter gain, validation range: `(0, 5)`, validation range: `(0, 5)`, action if invalid: `warn`
- `I_lr::Float64`: Exciter output current limit reference, validation range: `(0, 5)`, validation range: `(0, 5)`, action if invalid: `warn`
...
set_internal!(value::ESST1A, val) = value.internal = val
