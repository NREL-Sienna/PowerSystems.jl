...
- `control_objective::TransformerControlObjective`: (default: `TransformerControlObjective.UNDEFINED`) Control objective for the tap changer for power flow calculations. See [`TransformerControlObjective`](@ref TransformerControlObjective)
...
mutable struct TapTransformer <: TwoWindingTransformer
    ...
    winding_group_number::WindingGroupNumber
    "Control objective for the tap changer for power flow calculations. See [`TransformerControlObjective`](@ref TransformerControlObjective)"
    control_objective::TransformerControlObjective
