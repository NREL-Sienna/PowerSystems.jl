...
function ThermalMultiStart(name, available, status, bus, active_power, reactive_power, rating, prime_mover_type, fuel, active_power_limits, reactive_power_limits, ramp_limits, power_trajectory, time_limits, start_time_limits, start_types, operation_cost, base_power, services=Device[], time_at_status=INFINITE_TIME, must_run=false, dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, status = status, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, prime_mover_type = prime_mover_type, fuel = fuel, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, ramp_limits = ramp_limits, power_trajectory = power_trajectory, time_limits = time_limits, start_time_limits = start_time_limits, start_types = start_types, operation_cost = operation_cost, base_power = base_power, services = services, time_at_status = time_at_status, must_run = must_run, dynamic_injector = dynamic_injector, ext = ext, )
    ThermalMultiStart(name, available, status, bus, construct_value(ThermalMultiStart, _construction_fields, Val(:active_power), Val(:mva)), construct_value(ThermalMultiStart, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(ThermalMultiStart, _construction_fields, Val(:rating), Val(:mva)), prime_mover_type, fuel, construct_value(ThermalMultiStart, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(ThermalMultiStart, _construction_fields, Val(:reactive_power_limits), Val(:mva)), construct_value(ThermalMultiStart, _construction_fields, Val(:ramp_limits), Val(:mva)), construct_value(ThermalMultiStart, _construction_fields, Val(:power_trajectory), Val(:mva)), time_limits, start_time_limits, start_types, operation_cost, base_power, services, time_at_status, must_run, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end
