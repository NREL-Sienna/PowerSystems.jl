...
mutable struct RenewableEnergyConverterTypeA <: Converter
    ...
    Lvpl_sw::Int
    "(optional) Initial condition of reactive power from power flow"
    Q_ref::Float64
    "(optional) Output resistor used for the Thevenin Equivalent"
    R_source::Float64
    "(optional) Output reactance used for the Thevenin Equivalent"
    X_source::Float64
