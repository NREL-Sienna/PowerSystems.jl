...
- `Q_ref::Float64`: Initial condition of reactive power from power flow, validation range: `(0, nothing)`
- `R_source::Float64`: Output resistor used for the Thevenin Equivalent, validation range: `(0, nothing)`
- `X_source::Float64`: Output reactance used for the Thevenin Equivalent, validation range: `(0, nothing)`
