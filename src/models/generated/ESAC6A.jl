...
- `Ka::Float64`: Regulator output gain, validation range: `(0, 1000)`, validation range: `(0, 1000)`, action if invalid: `warn`
- `Ta::Float64`: Regulator output lag time constant in s, validation range: `(0, 10)`, validation range: `(0, 10)`, action if invalid: `warn`
- `Tk::Float64`: Voltage Regulator lead time constant, validation range: `(0, 10)`, validation range: `(0, 10)`, action if invalid: `warn`
- `Tb::Float64`: Regulator denominator (lag) time constant in s, validation range: `(0, 20)`, validation range: `(0, 20)`, action if invalid: `warn`
- `Tc::Float64`: Regulator numerator (lead) time constant in s, validation range: `(0, 20)`, validation range: `(0, 20)`, action if invalid: `warn`
...
- `Te::Float64`: Exciter field time constant, validation range: `("eps()", 2)`, validation range: `("eps()", 2)`, action if invalid: `error`
- `VFE_lim::Float64`: Exciter field current limiter reference, validation range: `(-5, 20)`, validation range: `(-5, 20)`, action if invalid: `warn`
- `Kh::Float64`: Exciter field current regulator feedback gain, validation range: `(0, 100)`, validation range: `(0, 100)`, action if invalid: `warn`
- `VH_max::Float64`: Exciter field current limiter maximum output, validation range: `(0, 100)`, validation range: `(0, 100)`, action if invalid: `warn`
- `Th::Float64`: Exciter field current limiter denominator (lag) time constant, validation range: `(0, 1)`, validation range: `(0, 1)`
- `Tj::Float64`: Exciter field current limiter numerator (lead) time constant, validation range: `(0, 1)`, validation range: `(0, 1)`, action if invalid: `warn`
- `Kc::Float64`: Rectifier loading factor proportional to commutating reactance, validation range: `(0, 1)`, validation range: `(0, 1)`
- `Kd::Float64`: Demagnetizing factor, function of exciter alternator reactances, validation range: `(0, 2)`, validation range: `(0, 2)`, action if invalid: `warn`
- `Ke::Float64`: Exciter field proportional constant, validation range: `(0, 2)`, validation range: `(0, 2)`, action if invalid: `warn`
