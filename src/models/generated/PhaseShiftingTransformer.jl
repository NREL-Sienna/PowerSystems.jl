...
"""Get [`PhaseShiftingTransformer`](@ref) `active_power_flow`. Returns value in the system's unit setting (natural units by default)."""
get_active_power_flow(value::PhaseShiftingTransformer) = get_value(value, Val(:active_power_flow), Val(:mva), _get_system_units(value, Val(:mva)))
get_active_power_flow(value::PhaseShiftingTransformer, units) = get_value(value, Val(:active_power_flow), Val(:mva), units)
"""Get [`PhaseShiftingTransformer`](@ref) `reactive_power_flow`. Returns value in the system's unit setting (natural units by default)."""
get_reactive_power_flow(value::PhaseShiftingTransformer) = get_value(value, Val(:reactive_power_flow), Val(:mva), _get_system_units(value, Val(:mva)))
...
"""Get [`PhaseShiftingTransformer`](@ref) `r`. Returns value in the system's unit setting (natural units by default)."""
get_r(value::PhaseShiftingTransformer) = get_value(value, Val(:r), Val(:ohm), _get_system_units(value, Val(:ohm)))
get_r(value::PhaseShiftingTransformer, units) = get_value(value, Val(:r), Val(:ohm), units)
"""Get [`PhaseShiftingTransformer`](@ref) `x`. Returns value in the system's unit setting (natural units by default)."""
get_x(value::PhaseShiftingTransformer) = get_value(value, Val(:x), Val(:ohm), _get_system_units(value, Val(:ohm)))
get_x(value::PhaseShiftingTransformer, units) = get_value(value, Val(:x), Val(:ohm), units)
"""Get [`PhaseShiftingTransformer`](@ref) `primary_shunt`. Returns value in the system's unit setting (natural units by default)."""
get_primary_shunt(value::PhaseShiftingTransformer) = get_value(value, Val(:primary_shunt), Val(:siemens), _get_system_units(value, Val(:siemens)))
...
"""Get [`PhaseShiftingTransformer`](@ref) `rating_b`. Returns value in the system's unit setting (natural units by default)."""
get_rating_b(value::PhaseShiftingTransformer) = get_value(value, Val(:rating_b), Val(:mva), _get_system_units(value, Val(:mva)))
get_rating_b(value::PhaseShiftingTransformer, units) = get_value(value, Val(:rating_b), Val(:mva), units)
"""Get [`PhaseShiftingTransformer`](@ref) `rating_c`. Returns value in the system's unit setting (natural units by default)."""
get_rating_c(value::PhaseShiftingTransformer) = get_value(value, Val(:rating_c), Val(:mva), _get_system_units(value, Val(:mva)))
