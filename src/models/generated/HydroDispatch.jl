...
function HydroDispatch(name, available, bus, active_power, reactive_power, rating, prime_mover_type, active_power_limits, reactive_power_limits, ramp_limits, time_limits, base_power, status=false, time_at_status=INFINITE_TIME, operation_cost=HydroGenerationCost(nothing), services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, prime_mover_type = prime_mover_type, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, ramp_limits = ramp_limits, time_limits = time_limits, base_power = base_power, status = status, time_at_status = time_at_status, operation_cost = operation_cost, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    HydroDispatch(name, available, bus, construct_value(HydroDispatch, _construction_fields, Val(:active_power), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:rating), Val(:mva)), prime_mover_type, construct_value(HydroDispatch, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:reactive_power_limits), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:ramp_limits), Val(:mva)), time_limits, base_power, status, time_at_status, operation_cost, services, dynamic_injector, ext, InfrastructureSystemsInternal(), )
end

function HydroDispatch(; name, available, bus, active_power, reactive_power, rating, prime_mover_type, active_power_limits, reactive_power_limits, ramp_limits, time_limits, base_power, status=false, time_at_status=INFINITE_TIME, operation_cost=HydroGenerationCost(nothing), services=Device[], dynamic_injector=nothing, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, bus = bus, active_power = active_power, reactive_power = reactive_power, rating = rating, prime_mover_type = prime_mover_type, active_power_limits = active_power_limits, reactive_power_limits = reactive_power_limits, ramp_limits = ramp_limits, time_limits = time_limits, base_power = base_power, status = status, time_at_status = time_at_status, operation_cost = operation_cost, services = services, dynamic_injector = dynamic_injector, ext = ext, )
    HydroDispatch(name, available, bus, construct_value(HydroDispatch, _construction_fields, Val(:active_power), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:reactive_power), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:rating), Val(:mva)), prime_mover_type, construct_value(HydroDispatch, _construction_fields, Val(:active_power_limits), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:reactive_power_limits), Val(:mva)), construct_value(HydroDispatch, _construction_fields, Val(:ramp_limits), Val(:mva)), time_limits, base_power, status, time_at_status, operation_cost, services, dynamic_injector, ext, internal, )
end
...
get_active_power(value::HydroDispatch, units) = InfrastructureSystems._strip_units(get_value(value, Val(:active_power), Val(:mva), units))
...
get_active_power_unitful(value::HydroDispatch, units) = get_value(value, Val(:active_power), Val(:mva), units)
...
get_reactive_power(value::HydroDispatch, units) = InfrastructureSystems._strip_units(get_value(value, Val(:reactive_power), Val(:mva), units))
...
get_reactive_power_unitful(value::HydroDispatch, units) = get_value(value, Val(:reactive_power), Val(:mva), units)
...
get_active_power_limits(value::HydroDispatch, units) = InfrastructureSystems._strip_units(get_value(value, Val(:active_power_limits), Val(:mva), units))
...
get_active_power_limits_unitful(value::HydroDispatch, units) = get_value(value, Val(:active_power_limits), Val(:mva), units)
...
get_reactive_power_limits(value::HydroDispatch, units) = InfrastructureSystems._strip_units(get_value(value, Val(:reactive_power_limits), Val(:mva), units))
...
get_reactive_power_limits_unitful(value::HydroDispatch, units) = get_value(value, Val(:reactive_power_limits), Val(:mva), units)
...
get_ramp_limits(value::HydroDispatch, units) = InfrastructureSystems._strip_units(get_value(value, Val(:ramp_limits), Val(:mva), units))
...
get_ramp_limits_unitful(value::HydroDispatch, units) = get_value(value, Val(:ramp_limits), Val(:mva), units)
