...
get_active_power(value::HydroDispatch) = get_value(value, value.active_power, Val(:mva))
"""Get [`HydroDispatch`](@ref) `reactive_power`."""
get_reactive_power(value::HydroDispatch) = get_value(value, value.reactive_power, Val(:mva))
"""Get [`HydroDispatch`](@ref) `rating`."""
get_rating(value::HydroDispatch) = get_value(value, value.rating, Val(:mva))
...
get_active_power_limits(value::HydroDispatch) = get_value(value, value.active_power_limits, Val(:mva))
"""Get [`HydroDispatch`](@ref) `reactive_power_limits`."""
get_reactive_power_limits(value::HydroDispatch) = get_value(value, value.reactive_power_limits, Val(:mva))
"""Get [`HydroDispatch`](@ref) `ramp_limits`."""
get_ramp_limits(value::HydroDispatch) = get_value(value, value.ramp_limits, Val(:mva))
...
set_active_power!(value::HydroDispatch, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`HydroDispatch`](@ref) `reactive_power`."""
set_reactive_power!(value::HydroDispatch, val) = value.reactive_power = set_value(value, val, Val(:mva))
"""Set [`HydroDispatch`](@ref) `rating`."""
set_rating!(value::HydroDispatch, val) = value.rating = set_value(value, val, Val(:mva))
...
set_active_power_limits!(value::HydroDispatch, val) = value.active_power_limits = set_value(value, val, Val(:mva))
"""Set [`HydroDispatch`](@ref) `reactive_power_limits`."""
set_reactive_power_limits!(value::HydroDispatch, val) = value.reactive_power_limits = set_value(value, val, Val(:mva))
"""Set [`HydroDispatch`](@ref) `ramp_limits`."""
set_ramp_limits!(value::HydroDispatch, val) = value.ramp_limits = set_value(value, val, Val(:mva))
