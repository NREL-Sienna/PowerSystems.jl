...
get_active_power_flow(value::DiscreteControlledACBranch) = get_value(value, value.active_power_flow, Val(:mva))
"""Get [`DiscreteControlledACBranch`](@ref) `reactive_power_flow`."""
get_reactive_power_flow(value::DiscreteControlledACBranch) = get_value(value, value.reactive_power_flow, Val(:mva))
...
get_rating(value::DiscreteControlledACBranch) = get_value(value, value.rating, Val(:mva))
...
set_active_power_flow!(value::DiscreteControlledACBranch, val) = value.active_power_flow = set_value(value, val, Val(:mva))
"""Set [`DiscreteControlledACBranch`](@ref) `reactive_power_flow`."""
set_reactive_power_flow!(value::DiscreteControlledACBranch, val) = value.reactive_power_flow = set_value(value, val, Val(:mva))
...
set_rating!(value::DiscreteControlledACBranch, val) = value.rating = set_value(value, val, Val(:mva))
