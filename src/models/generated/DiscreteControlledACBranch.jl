...
function DiscreteControlledACBranch(name, available, active_power_flow, reactive_power_flow, arc, r, x, rating, discrete_branch_type=DiscreteControlledBranchType.OTHER, branch_status=DiscreteControlledBranchStatus.CLOSED, normal_branch_status=DiscreteControlledBranchStatus.CLOSED, base_power=100.0, ext=Dict{String, Any}(), )
    _construction_fields = (name = name, available = available, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, arc = arc, r = r, x = x, rating = rating, discrete_branch_type = discrete_branch_type, branch_status = branch_status, normal_branch_status = normal_branch_status, base_power = base_power, ext = ext, )
    DiscreteControlledACBranch(name, available, construct_value(DiscreteControlledACBranch, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(DiscreteControlledACBranch, _construction_fields, Val(:reactive_power_flow), Val(:mva)), arc, construct_value(DiscreteControlledACBranch, _construction_fields, Val(:r), Val(:ohm)), construct_value(DiscreteControlledACBranch, _construction_fields, Val(:x), Val(:ohm)), construct_value(DiscreteControlledACBranch, _construction_fields, Val(:rating), Val(:mva)), discrete_branch_type, branch_status, normal_branch_status, base_power, ext, InfrastructureSystemsInternal(), )
end

function DiscreteControlledACBranch(; name, available, active_power_flow, reactive_power_flow, arc, r, x, rating, discrete_branch_type=DiscreteControlledBranchType.OTHER, branch_status=DiscreteControlledBranchStatus.CLOSED, normal_branch_status=DiscreteControlledBranchStatus.CLOSED, base_power=100.0, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), )
    _construction_fields = (name = name, available = available, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, arc = arc, r = r, x = x, rating = rating, discrete_branch_type = discrete_branch_type, branch_status = branch_status, normal_branch_status = normal_branch_status, base_power = base_power, ext = ext, )
    DiscreteControlledACBranch(name, available, construct_value(DiscreteControlledACBranch, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(DiscreteControlledACBranch, _construction_fields, Val(:reactive_power_flow), Val(:mva)), arc, construct_value(DiscreteControlledACBranch, _construction_fields, Val(:r), Val(:ohm)), construct_value(DiscreteControlledACBranch, _construction_fields, Val(:x), Val(:ohm)), construct_value(DiscreteControlledACBranch, _construction_fields, Val(:rating), Val(:mva)), discrete_branch_type, branch_status, normal_branch_status, base_power, ext, internal, )
end
