...
- `Ke::Float64`: Exciter constant related to self-excited field, validation range: `(-1, 1)`, validation range: `(-1, 1)`
- `Te::Float64`: Exciter time constant, integration rate associated with exciter control, validation range: `("eps()", 1)`, validation range: `("eps()", 1)`, action if invalid: `error`
- `Kf::Float64`: Excitation control system stabilizer gain, validation range: `("eps()", 0.3)`, validation range: `("eps()", 0.3)`, action if invalid: `warn`
- `Tf::Float64`: Excitation control system stabilizer time constant. Appropiate Data: 5 <= Tf/Kf <= 15, validation range: `("eps()", nothing)`, validation range: `("eps()", nothing)`, action if invalid: `error`
