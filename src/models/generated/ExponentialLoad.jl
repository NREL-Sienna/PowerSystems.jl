...
get_active_power(value::ExponentialLoad) = get_value(value, value.active_power, Val(:mva))
"""Get [`ExponentialLoad`](@ref) `reactive_power`."""
get_reactive_power(value::ExponentialLoad) = get_value(value, value.reactive_power, Val(:mva))
...
get_max_active_power(value::ExponentialLoad) = get_value(value, value.max_active_power, Val(:mva))
"""Get [`ExponentialLoad`](@ref) `max_reactive_power`."""
get_max_reactive_power(value::ExponentialLoad) = get_value(value, value.max_reactive_power, Val(:mva))
...
set_active_power!(value::ExponentialLoad, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`ExponentialLoad`](@ref) `reactive_power`."""
set_reactive_power!(value::ExponentialLoad, val) = value.reactive_power = set_value(value, val, Val(:mva))
...
set_max_active_power!(value::ExponentialLoad, val) = value.max_active_power = set_value(value, val, Val(:mva))
"""Set [`ExponentialLoad`](@ref) `max_reactive_power`."""
set_max_reactive_power!(value::ExponentialLoad, val) = value.max_reactive_power = set_value(value, val, Val(:mva))
