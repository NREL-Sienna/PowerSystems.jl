...
function TransformerCircuit(available, arc, tap=1.0, α=0.0, r=0.0, x=0.0, control_objective=TransformerControlObjective.UNDEFINED, regulated_bus_number=0, control_limits=(min=0.9, max=1.1), controlled_quantity_limits=(min=0.9, max=1.1), number_of_tap_positions=33, rating=nothing, rating_b=nothing, rating_c=nothing, active_power_flow=0.0, reactive_power_flow=0.0, base_power=100.0, base_voltage_primary=nothing, base_voltage_secondary=nothing, )
    _construction_fields = (available = available, arc = arc, tap = tap, α = α, r = r, x = x, control_objective = control_objective, regulated_bus_number = regulated_bus_number, control_limits = control_limits, controlled_quantity_limits = controlled_quantity_limits, number_of_tap_positions = number_of_tap_positions, rating = rating, rating_b = rating_b, rating_c = rating_c, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, base_power = base_power, base_voltage_primary = base_voltage_primary, base_voltage_secondary = base_voltage_secondary, )
    TransformerCircuit(available, arc, tap, α, construct_value(TransformerCircuit, _construction_fields, Val(:r), Val(:ohm)), construct_value(TransformerCircuit, _construction_fields, Val(:x), Val(:ohm)), control_objective, regulated_bus_number, control_limits, controlled_quantity_limits, number_of_tap_positions, construct_value(TransformerCircuit, _construction_fields, Val(:rating), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:rating_b), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:rating_c), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:reactive_power_flow), Val(:mva)), base_power, base_voltage_primary, base_voltage_secondary, nothing, )
end
...
function TransformerCircuit(; available, arc, tap=1.0, α=0.0, r=0.0, x=0.0, control_objective=TransformerControlObjective.UNDEFINED, regulated_bus_number=0, control_limits=(min=0.9, max=1.1), controlled_quantity_limits=(min=0.9, max=1.1), number_of_tap_positions=33, rating=nothing, rating_b=nothing, rating_c=nothing, active_power_flow=0.0, reactive_power_flow=0.0, base_power=100.0, base_voltage_primary=nothing, base_voltage_secondary=nothing, base_value=nothing, )
    _construction_fields = (available = available, arc = arc, tap = tap, α = α, r = r, x = x, control_objective = control_objective, regulated_bus_number = regulated_bus_number, control_limits = control_limits, controlled_quantity_limits = controlled_quantity_limits, number_of_tap_positions = number_of_tap_positions, rating = rating, rating_b = rating_b, rating_c = rating_c, active_power_flow = active_power_flow, reactive_power_flow = reactive_power_flow, base_power = base_power, base_voltage_primary = base_voltage_primary, base_voltage_secondary = base_voltage_secondary, )
    TransformerCircuit(available, arc, tap, α, construct_value(TransformerCircuit, _construction_fields, Val(:r), Val(:ohm)), construct_value(TransformerCircuit, _construction_fields, Val(:x), Val(:ohm)), control_objective, regulated_bus_number, control_limits, controlled_quantity_limits, number_of_tap_positions, construct_value(TransformerCircuit, _construction_fields, Val(:rating), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:rating_b), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:rating_c), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:active_power_flow), Val(:mva)), construct_value(TransformerCircuit, _construction_fields, Val(:reactive_power_flow), Val(:mva)), base_power, base_voltage_primary, base_voltage_secondary, base_value, )
end
