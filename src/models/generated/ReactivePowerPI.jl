...
- `V_ref::Float64`: (default: `1.0`) (optional) Voltage Set-point (pu), validation range: `(0, nothing)`
- `Q_ref::Float64`: (default: `1.0`) (optional) Reactive Power Set-point (pu), validation range: `(0, nothing)`
