...
get_active_power(value::HydroEnergyReservoir) = get_value(value, value.active_power, Val(:mva))
"""Get [`HydroEnergyReservoir`](@ref) `reactive_power`."""
get_reactive_power(value::HydroEnergyReservoir) = get_value(value, value.reactive_power, Val(:mva))
"""Get [`HydroEnergyReservoir`](@ref) `rating`."""
get_rating(value::HydroEnergyReservoir) = get_value(value, value.rating, Val(:mva))
...
get_active_power_limits(value::HydroEnergyReservoir) = get_value(value, value.active_power_limits, Val(:mva))
"""Get [`HydroEnergyReservoir`](@ref) `reactive_power_limits`."""
get_reactive_power_limits(value::HydroEnergyReservoir) = get_value(value, value.reactive_power_limits, Val(:mva))
"""Get [`HydroEnergyReservoir`](@ref) `ramp_limits`."""
get_ramp_limits(value::HydroEnergyReservoir) = get_value(value, value.ramp_limits, Val(:mva))
...
get_storage_capacity(value::HydroEnergyReservoir) = get_value(value, value.storage_capacity, Val(:mva))
"""Get [`HydroEnergyReservoir`](@ref) `inflow`."""
get_inflow(value::HydroEnergyReservoir) = get_value(value, value.inflow, Val(:mva))
"""Get [`HydroEnergyReservoir`](@ref) `initial_storage`."""
get_initial_storage(value::HydroEnergyReservoir) = get_value(value, value.initial_storage, Val(:mva))
...
set_active_power!(value::HydroEnergyReservoir, val) = value.active_power = set_value(value, val, Val(:mva))
"""Set [`HydroEnergyReservoir`](@ref) `reactive_power`."""
set_reactive_power!(value::HydroEnergyReservoir, val) = value.reactive_power = set_value(value, val, Val(:mva))
"""Set [`HydroEnergyReservoir`](@ref) `rating`."""
set_rating!(value::HydroEnergyReservoir, val) = value.rating = set_value(value, val, Val(:mva))
...
set_active_power_limits!(value::HydroEnergyReservoir, val) = value.active_power_limits = set_value(value, val, Val(:mva))
"""Set [`HydroEnergyReservoir`](@ref) `reactive_power_limits`."""
set_reactive_power_limits!(value::HydroEnergyReservoir, val) = value.reactive_power_limits = set_value(value, val, Val(:mva))
"""Set [`HydroEnergyReservoir`](@ref) `ramp_limits`."""
set_ramp_limits!(value::HydroEnergyReservoir, val) = value.ramp_limits = set_value(value, val, Val(:mva))
...
set_storage_capacity!(value::HydroEnergyReservoir, val) = value.storage_capacity = set_value(value, val, Val(:mva))
"""Set [`HydroEnergyReservoir`](@ref) `inflow`."""
set_inflow!(value::HydroEnergyReservoir, val) = value.inflow = set_value(value, val, Val(:mva))
"""Set [`HydroEnergyReservoir`](@ref) `initial_storage`."""
set_initial_storage!(value::HydroEnergyReservoir, val) = value.initial_storage = set_value(value, val, Val(:mva))
