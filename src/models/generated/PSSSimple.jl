...
# Arguments
- `K_ω::Float64`: Proportional gain for frequency, validation range: `(0, nothing)`, validation range: `(0, nothing)`
- `K_p::Float64`: Proportional gain for active power, validation range: `(0, nothing)`, validation range: `(0, nothing)`
- `ext::Dict{String, Any}`
- `states::Vector{Symbol}`
