...
"""Get [`HydroPumpTurbine`](@ref) `active_power`. Returns natural units (MW) by default."""
get_active_power(value::HydroPumpTurbine) = get_value(value, Val(:active_power), Val(:mva), MW)
get_active_power(value::HydroPumpTurbine, units) = get_value(value, Val(:active_power), Val(:mva), units)
"""Get [`HydroPumpTurbine`](@ref) `reactive_power`. Returns natural units (Mvar) by default."""
get_reactive_power(value::HydroPumpTurbine) = get_value(value, Val(:reactive_power), Val(:mva), Mvar)
get_reactive_power(value::HydroPumpTurbine, units) = get_value(value, Val(:reactive_power), Val(:mva), units)
"""Get [`HydroPumpTurbine`](@ref) `rating`. Returns natural units (MW) by default."""
get_rating(value::HydroPumpTurbine) = get_value(value, Val(:rating), Val(:mva), MW)
get_rating(value::HydroPumpTurbine, units) = get_value(value, Val(:rating), Val(:mva), units)
"""Get [`HydroPumpTurbine`](@ref) `active_power_limits`. Returns natural units (MW) by default."""
get_active_power_limits(value::HydroPumpTurbine) = get_value(value, Val(:active_power_limits), Val(:mva), MW)
get_active_power_limits(value::HydroPumpTurbine, units) = get_value(value, Val(:active_power_limits), Val(:mva), units)
"""Get [`HydroPumpTurbine`](@ref) `reactive_power_limits`. Returns natural units (Mvar) by default."""
get_reactive_power_limits(value::HydroPumpTurbine) = get_value(value, Val(:reactive_power_limits), Val(:mva), Mvar)
get_reactive_power_limits(value::HydroPumpTurbine, units) = get_value(value, Val(:reactive_power_limits), Val(:mva), units)
"""Get [`HydroPumpTurbine`](@ref) `active_power_limits_pump`. Returns natural units (MW) by default."""
get_active_power_limits_pump(value::HydroPumpTurbine) = get_value(value, Val(:active_power_limits_pump), Val(:mva), MW)
...
"""Get [`HydroPumpTurbine`](@ref) `ramp_limits`. Returns natural units (MW) by default."""
get_ramp_limits(value::HydroPumpTurbine) = get_value(value, Val(:ramp_limits), Val(:mva), MW)
...
"""Get [`HydroPumpTurbine`](@ref) `active_power_pump`. Returns natural units (MW) by default."""
get_active_power_pump(value::HydroPumpTurbine) = get_value(value, Val(:active_power_pump), Val(:mva), MW)
